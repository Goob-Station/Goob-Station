...
public sealed partial class CassettePlayerComponent : Component
{
    ...
    [DataField, AutoNetworkedField]
    public SoundSpecifier PlayPauseSound = new SoundPathSpecifier("/Audio/_Pirate/Cassette/Effects/click.ogg");

    [DataField, AutoNetworkedField]
    public SoundSpecifier InsertEjectSound = new SoundPathSpecifier("/Audio/_Pirate/Cassette/Effects/handcuffs.ogg");

    [DataField, AutoNetworkedField]
    public SpriteSpecifier.Rsi WornSprite = new(new ResPath("_Pirate/Cassette/Objects/Devices/cassette_player.rsi"), "mob_overlay");

    [DataField, AutoNetworkedField]
    public SpriteSpecifier.Rsi MusicSprite = new(new ResPath("_Pirate/Cassette/Objects/Devices/cassette_player.rsi"), "music");
}
