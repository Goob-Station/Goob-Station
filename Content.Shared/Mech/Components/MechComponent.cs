...
{
    /// <summary>
    /// Goidastation: Whether or not an emag disables it.
    /// </summary>
    ...
    [DataField]
    public EntProtoId ToggleAction = "ActionToggleLight"; //Goidastation Mech Lights toggle action
    [DataField]
    ...
    [DataField, AutoNetworkedField] public EntityUid? ToggleActionEntity; //Goidastation Mech Lights toggle action
}
