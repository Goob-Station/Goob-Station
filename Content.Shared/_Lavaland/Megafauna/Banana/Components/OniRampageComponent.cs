...
/// <summary>
/// Component that handles dashing towards a target and then creating a ring of
/// entities where you land, dealing AoE damage on impact.
/// </summary>
...
public sealed partial class OniRampageComponent : Component
{
    ...
    /// <summary>
    /// The entity spawned in a ring around the landing point.
    /// </summary>
    [DataField]
    [ValidatePrototypeId<EntityPrototype>]
    public EntProtoId RingPrototype = "HereticFireAA";
}
