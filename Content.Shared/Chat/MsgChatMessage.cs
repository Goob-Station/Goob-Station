...
namespace Content.Shared.Chat
{
    ...
    public sealed class ChatMessage
    {
        ...
        public int? FontSizeOverride; // Goobstation loud command

        [NonSerialized]
        public bool Read;

        // Goobstation Edit - Coalescing Chat
        public ChatMessage(ChatChannel channel, string message, string wrappedMessage, NetEntity source, int? senderKey, bool hideChat = false, Color? colorOverride = null, string? audioPath = null, float audioVolume = 0, bool canCoalesce = true, int? fontSizeOverride = null)
        {
            Channel = channel;
            Message = message;
            ...
            FontSizeOverride = fontSizeOverride; // Goobstation loud command
        }
    }
