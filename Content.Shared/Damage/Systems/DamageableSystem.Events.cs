...
/// </summary>
[ByRefEvent]
// Goob - shitmed Added CanBeCancelled, TargetPart
public record struct BeforeDamageChangedEvent(DamageSpecifier Damage, EntityUid? Origin = null, bool CanBeCancelled = false, TargetBodyPart? TargetPart = null, bool Cancelled = false); // Goob - shitmed Added CanBeCancelled, TargetPart
...
public sealed partial class DamageChangedEvent : EntityEventArgs // Goob - made partial
{
    ...
    public DamageChangedEvent(
        ...
        DamageSpecifier? uncapped = null // Goob - shitmed
    )
    {
