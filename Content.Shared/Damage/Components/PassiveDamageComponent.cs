...
public sealed partial class PassiveDamageComponent : Component
{
    ...
    [DataField("nextDamage", customTypeSerializer: typeof(TimeOffsetSerializer)), ViewVariables(VVAccess.ReadWrite), AutoNetworkedField] // Goobstation
