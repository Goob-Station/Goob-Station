...
public sealed partial class BloodsuckerMaterializeComponent : Component
{
    /// <summary>
    /// The structure to spawn.
    /// </summary>
    [DataField]
    public EntProtoId StructureProto = "BloodsuckerVassalRack";

    /// <summary>
    /// Health cost (brute) to materialize.
    /// </summary>
    [DataField]
    public float HealthCost = 30f;
