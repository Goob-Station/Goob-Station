...
public sealed partial class BloodsuckerVassalizeComponent : Component
{
    /// <summary>
    /// How long the vassalization process takes.
    /// </summary>
    [DataField]
    public float VassalizeDelay = 10f;

    [DataField]
    public SoundSpecifier? Sound = new SoundPathSpecifier("/Audio/Effects/stealthoff.ogg");
