...
using Content.Goobstation.Shared._Trauma.AnimalAgeing.Components;
using Content.Goobstation.Shared._Trauma.AnimalAgeing.Events;
using Content.Goobstation.Shared._Trauma.Ranching.Components;
using Content.Goobstation.Shared._Trauma.Ranching.Systems;
...
public sealed partial class SharedAnimalAgeingSystem : EntitySystem
{
    ...
    public void CopyAndReplaceEntity(EntProtoId entToSpawn, EntityUid uid)
    {
        ...
        var ev = new AnimalPolymorphRequestEvent(uid, poly);
