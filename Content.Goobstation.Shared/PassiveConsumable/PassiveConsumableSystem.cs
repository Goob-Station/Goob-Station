...
=======
        List<(EntityUid Uid, EdibleComponent Edible, EntityUid User)>? toSpawnTrash = null;
>>>>>>> 54c5416e665eb27324edfdc2bcfb7aee78d0b5d9
...
=======
            if (TryConsume((uid, comp), edible))
            {
                toSpawnTrash ??= [];
                toSpawnTrash.Add((uid, edible, comp.Wearer!.Value));
>>>>>>> 54c5416e665eb27324edfdc2bcfb7aee78d0b5d9
            }
...
=======
        if (toSpawnTrash == null)
            return;

        foreach (var (uid, edible, user) in toSpawnTrash)
            _ingestion.SpawnTrash((uid, edible), user);
    }
...
<<<<<<< HEAD
        ...
        return true;
=======
        return ent.Comp.SpawnTrashOnEmpty;
>>>>>>> 54c5416e665eb27324edfdc2bcfb7aee78d0b5d9
    }
}
