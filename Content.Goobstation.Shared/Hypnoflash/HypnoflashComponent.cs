...
public sealed partial class HypnoflashComponent : Component
{
    ...
    [DataField]
    public TimeSpan FullDuration = TimeSpan.FromSeconds(8);

    [DataField]
    public TimeSpan Duration = TimeSpan.FromSeconds(4.5); // also yes this is horrible

    [DataField]
    public EntProtoId? ProtoOnFlash; // will spawn the said entity after the spawn delay is at 0
