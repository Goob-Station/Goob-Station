news-dataset-1 = Un arbre coincé dans un tajarane ; les pompiers sont perplexes.
news-dataset-2 = Armadillos want aardvarks removed from dictionary claims 'here first'.
news-dataset-3 = Un ange trouvé en train de danser sur une tête d'épingle est sommé de s'arrêter ; cité pour nuisance publique.
news-dataset-4 = Les lettres prétendent être meilleures que les chiffres ; 'Toujours été'.
news-dataset-5 = Les stylos proclament que les crayons sont obsolètes, 'le plomb est mort'.
news-dataset-6 = La pierre et le papier poursuivent les ciseaux pour discrimination.
...
news-dataset-10 = Un homme voyage 7000 années-lumière pour récupérer un mouchoir perdu, 'C'était mon préféré'.
news-dataset-11 = Nouvelle piste de bowling qui tire des mini-météores sur les joueurs très populaire.
...
news-dataset-14 = NanoTrasen invente un mouchoir qui dit 'À tes souhaits' après un éternuement.
