...
guidebook-microwave-ingredients-header = Ingrédients
guidebook-microwave-cook-time-header =  Temps de cuisson
guidebook-microwave-cook-time =
    { $time ->
        [0] Instantané
        [1] [bold]1[/bold] seconde
       *[other] [bold]{$time}[/bold] secondes
    }
