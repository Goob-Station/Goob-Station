...
guidebook-SOP-codes-green-terms = - На станции отсутствуют угрозы безопасности.
...
guidebook-SOP-codes-octarine-terms = - Центральное Командование зафиксировала угрозу, серьёзно искажающую реальность.
...
guidebook-SOP-codes-omicrone-terms = - Нет доступа.
