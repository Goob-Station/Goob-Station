...
guidebook-SOP-engineering-general-prohibited = 1. Строить дополнительные источники питания, пока по крайней мере один источник питания не будет правильно подключен и настроен.
...
guidebook-SOP-SeniorEngineer-prohibited = 1. Извлекать пожарный топор из шкафчика без непосредственной угрозы жизни или необходимости срочного доступа.
...
guidebook-SOP-StationEngineer-right = 1. Взламывать двери, чтобы получить несанкционированный доступ к отсеку, если данный отсек требует срочного ремонта, предупредив ответственного за отсек по рации или лично.
...
guidebook-SOP-TechnicalAssistant-must = 1. Быть приписанным к старшему сотруднику отдела для обучения и прохождения практики.
guidebook-SOP-TechnicalAssistant-right = 1. В пределах своих сил и знаний помогать сотрудникам отдела с выполнением рабочих задач.
guidebook-SOP-TechnicalAssistant-prohibited =
    ...
    1. Носить скафандр отдела без необходимости его применения.
# Tooltip
guidebook-SOP-engineering-tooltip-safety-precautions =
