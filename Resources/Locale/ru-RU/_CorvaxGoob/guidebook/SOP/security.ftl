...
guidebook-SOP-security-procedure-prisoner = { "[italic]Заключение — мера наказания, применяемая в отношении осуждённых лиц. В зависимости от тяжести правонарушения осуждённый может быть приговорён к временному либо пожизненному заключению. Местами содержания заключённых являются одиночная (либо двухместная) камера, пермабриг, каторга, карцер.[/italic]" }
...
guidebook-SOP-security-procedure-tooltip-emergencies =
