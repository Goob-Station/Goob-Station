...
ent-ClothingUniformJumpsuitMilitaryResearchDirector = { ent-ClothingUniformJumpsuitResearchDirector }
    .desc = Этот комбинезон носят те, кто обладает что-почему для достижения должности директора по исследованиям. Его ткань обеспечивает незначительную защиту от биологических загрязнений.
    .suffix = Военный
