...
ent-PinpointerBorg = пинпоинтер киборга
    .desc = Ручное устройство слежения, которое фиксирует любого киборга в выключенном состоянии. Держите вертикально для сохранения точности.
...
ent-PinpointerThief = пинпоинтер вора
    .desc = Ручное устройство слежения, которое может нацеливаться на любые ценные объекты, включая высокорисковые предметы и украдяемые структуры в выключенном состоянии. Держите вертикально для сохранения точности.
