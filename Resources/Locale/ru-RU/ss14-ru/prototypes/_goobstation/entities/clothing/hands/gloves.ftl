...
ent-ClothingHandsKnucklesQuartermaster = гравированный кастет кладовщика
    .desc = Кастет, выкованный лучшими мастерами по заказу кладовщика, твёрдый и плотный, предназначен для сокрушительных ударов и повреждения внутренних органов несчастной жертвы.
    .suffix = НЕ МАППИТЬ
