...
ent-MobMothSyndy = синдикатовое моль
    .desc = Взрывчатая моль.

ent-MobSyndieAngryBee = синдикатовое злое пчела
    .desc = Какая милая пчела. О нет, она злится и хочет мою пиццу.
    .suffix = Злая, синдикатская

ent-MobAngryBeeWeak = { ent-MobAngryBee }
    .suffix = Злая, слабая
    .desc = { ent-MobAngryBee.desc }

ent-MobLootbug = жучок-похититель
    .desc = Ест металл, может, уже что-то ценное съел?
