...
ent-NanotrasenRepresentativeIDCard = ID-карта представителя НаноТрейзен
    .desc = { ent-IDCardStandard.desc }
ent-NanotrasenCareerTrainerIDCard = ID-карта инструктора ЦК
    .desc = { ent-IDCardStandard.desc }
...
ent-CentcomIDCardNavyCaptain = ID-карта капитана ВКС
    .desc = { ent-IDCardStandard.desc }
ent-CentcomIDCardNavyOfficer = ID-карта офицера Центрального Командования
    .desc = { ent-CentcomIDCardNavyCaptain.desc }
ent-CentcomIDCardSpecialOperationsOfficer = ID-карта ОСО
    .desc = { ent-CentcomIDCardNavyCaptain.desc }
ent-CentcomIDCardInspector = ID-карта инспектора Центрального Командования
    .desc = { ent-CentcomIDCardNavyCaptain.desc }
ent-CentcomIDCardDiplomat = ID-карта дипломата НаноТрейзен
    .desc = { ent-CentcomIDCardNavyCaptain.desc }
