...
ent-ClothingHeadEnvirohelmNanotrasenRepresentative = экошлем инспектора Nanotrasen
    .desc = Чёрный экошлем для инспектора Nanotrasen с чёрными и золотыми акцентами.
