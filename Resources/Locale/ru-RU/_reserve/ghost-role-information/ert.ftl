ghost-role-information-cburnunitleaderReserve-name = лидер отряда РХБЗЗ
ghost-role-information-cburnunitleaderReserve-description = Лидер отряда РХБЗЗ. Повенуется приказам с ЦК.
...
ghost-role-information-ertengineerReserve-name = инженер ОБР
ghost-role-information-ertengineerReserve-description = Инженер отряда быстрого реагирования. Ваша первостепенная задача - выполнение приказов вашего лидера!

ghost-role-information-ertjanitorReserve-name = уборщик ОБР
ghost-role-information-ertjanitorReserve-description = Уборщик отряда быстрого реагирования. Ваша первостепенная задача - выполнение приказов вашего лидера!
