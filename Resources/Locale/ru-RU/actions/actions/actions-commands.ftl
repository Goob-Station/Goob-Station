...
upgradeaction-command-incorrect-entityuid-format = Необходимо использовать корректный формат entityuid.
upgradeaction-command-entity-does-not-exist = Этого объекта не существует. Требуется валидный объект.
upgradeaction-command-entity-is-not-action = Этот объект не имеет компонента улучшения действия, поэтому его нельзя улучшить.
upgradeaction-command-cannot-level-up = Это действие нельзя повысить.
