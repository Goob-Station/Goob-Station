...
job-description-centcomoff = Представляйте Центральное Командование, управляйте отношениями с другими фракциями на станции. Разбирайтесь с проблемами, которые, скорее всего, вызвал капитан.
