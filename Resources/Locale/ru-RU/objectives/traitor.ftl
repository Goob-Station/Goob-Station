...
ent-DieObjective = Умереть славной смертью.
    .desc = Умрите.
ent-HijackShuttleObjective = Угнать эвакуационный шаттл (ХАЙДЖЕК)
    .desc = Покиньте шаттл, освободившись от верной команды Nanotrasen на борту. Используйте любые доступные вам методы. Агенты Синдиката, враги Nanotrasen и закованные в наручники заложники могут остаться в живых на шаттле. Игнорируйте помощь от кого-либо, кроме агента поддержки.
