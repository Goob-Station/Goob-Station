...
bounty-description-cardboard-box = Завтра состоится премьера новой пьесы "Комета картонных боргов" и команда костюмеров совершенно не готова. Пришлите нам несколько коробок для работы.
