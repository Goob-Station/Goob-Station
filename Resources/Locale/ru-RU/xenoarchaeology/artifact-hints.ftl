...
xenoarch-trigger-tip-music = Гармоничные звоковые вибрации
xenoarch-trigger-tip-heat = Высокотемпературный газ
xenoarch-trigger-tip-cold = Низкотемпературный газ
xenoarch-trigger-tip-no-oxygen = Вакуумная среда
...
xenoarch-trigger-tip-nitrium = Азот
