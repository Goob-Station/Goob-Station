...
knowledge-path-side-s3-ashen-eyes-desc =
    ...
    Позволяет трансмутировать пару глаз, сигнальную ракету и осколок стекла в медальон Элдрича.
...
knowledge-path-side-s9-cleave-desc =
    ...
    Дает вам Cleave, заклинание направленного действия, вызывающее сильное кровотечение и потерю крови у всех, кто пострадал.
