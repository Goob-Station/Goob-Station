...
knowledge-path-blade-s1-desc =
    ...
    Трансмутируй 2 ножа в Расколотый Клинок. Лимит — четыре одновременно.
...
knowledge-path-blade-s2-desc =
    ...
    Ваша Хватка Мансуса оглушает цель на короткое время, если она лежит или стоит к вам спиной.
...
knowledge-path-blade-s3-desc =
    ...
    При атаке по вам, если вы держите Еретический Клинок в каждой руке, вы контратакуете, сбивая противника с ног.
...
knowledge-path-blade-s4-desc =
    ...
    Ваша Хватка Мансуса теперь накладывает Метку Клинка.
...
knowledge-path-blade-s5-desc =
    В водовороте смерти он обрёл внутренний покой. Несмотря на невозможные шансы, он продолжал идти вперёд.

    Даёт заклинание «Перестройка», которое на короткое время резко перестраивает ваше тело.
    Во время действия вы быстро восстанавливаете выносливость и выходите из оглушений, но не можете атаковать.

knowledge-path-blade-s6-name = Стойка Чемпиона
knowledge-path-blade-s6-desc =
    В конце концов, он остался один среди тел своих товарищей, залитый их кровью — но не своей. У него не осталось ни соперников, ни равных, ни цели.
...
knowledge-path-blade-s7-desc =
    ...
    Атака с двумя Расколотыми Клинками теперь наносит двойной удар.
    Второй удар немного слабее.
    Вы можете влить Хватку Мансуса прямо в клинки, и клинки становятся эффективнее против сооружений.
...
knowledge-path-blade-s8-desc =
    ...
    Даёт заклинание «Яростная Сталь» — целевое заклинание.
...
knowledge-path-blade-s9-desc =
    ...
    Клинки защищают от атак, но исчезают при блокировке.
    Заклинание «Яростная Сталь» будет перезаряжаться быстрее.
    Вы также становитесь мастером боя, способным танцевать даже по скользкой поверхности.
    Ваши Расколотые Клинки наносят дополнительный урон и лечат вас на часть нанесённого урона.
