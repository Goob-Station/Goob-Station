...
heretic-role-greeting =
    ...
    Подробнее о вашей роли читайте в путеводителе.
...
heretic-ghoul-greeting-noname =
    Вы были призваны в этот мир эльдрическими силами.
...
ghostrole-prophet-desc = Помочь своему призывателю в достижении вознесения. Подключать других верующих к Связке Мансуса.
ghostrole-stalker-desc = Помочь своему призывателю в достижении вознесения. Призраки саботируют освещение команды.
ghostrole-ghoul-rules = Вы являетесь [color=red][bold]командным антагонистом[/bold][/color] с тем, кто вызвал вас и других эльдрических существ.
