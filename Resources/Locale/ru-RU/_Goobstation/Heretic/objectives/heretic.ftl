...
objective-condition-knowledge-title = Изучите как минимум { $count } единиц знаний Мансуса.
...
objective-condition-description-ascend = Я должен это сделать, чтобы вознестись!
