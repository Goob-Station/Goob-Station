...
slaughter-role-greeting =
    ...
    Вы можете использовать значок «ползти по крови», находясь на кровавых лужах, чтобы перемещаться через них, появляясь и исчезая на станции по своему желанию.
