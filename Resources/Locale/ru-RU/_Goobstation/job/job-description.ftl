...
job-description-navy-special-operations-officer = Отправляйте, инструктируйте и руководите командами экстренного реагирования или другими силами Нанотрасена. Выпускайте ядерные коды — или нет.
