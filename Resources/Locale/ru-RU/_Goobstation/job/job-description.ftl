...
job-description-ntr = Представляйте Центральное Командование, отправляйте им отчеты о ситуации на станции и управляйте вектором отношений с другими фракциями. Разбирайтесь с проблемами, которые, скорее всего, вызвал капитан.
job-description-bs = Выступайте в качестве профессионального телохранителя и советника для важных персон на этой станции и станции Центрального Командования. Помните, Вам платят за спасенные жизни. Только за жизни важных персон, разумеется.
job-description-inspector = Представляйте Центральное Командование, отправляйте им отчеты о ситуации. Проводите расследования на станции и среди экипажа, дайте волю своему внутреннему дъяволу.
