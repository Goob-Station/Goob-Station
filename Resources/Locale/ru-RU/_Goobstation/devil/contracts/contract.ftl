...
devil-contract-contractor = исполнитель контракта
devil-contract-early-sign-failed = Исполнитель должен дождаться, пока получатель подпишет первым!
...
contract-uneven-odds = Эти шансы несправедливы. Вам нужно еще { $number } единиц веса контракта.
...
default-contract-content =
    ...
    - Инфернальная сторона (в дальнейшем "Исполнитель")
    ...
    { "[" }italic]{ "[" }color=#ac3a0d]Пункты не подлежат нарушению. Никогда.{ "[" }/color]{ "[" }/italic]
