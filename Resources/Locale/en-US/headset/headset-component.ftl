...
chat-radio-message-wrap-bold = [color={$color}]{$channel} [bold]{$name}[/bold] {$verb}, "[/color][bold][color={$languageColor}][font="{$fontType}" size={$fontSize}]{$message}[/font][/color][/bold][color={$color}]"[/color]
