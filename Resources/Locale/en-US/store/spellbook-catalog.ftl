...
spellbook-charge-desc =
    This spell can be used to recharge a variety of things in your hands, from magical artifacts to electrical components. A creative discord can even use it to grant magical power to a fellow magic user.
    Doesn't require discord's robe and hat to cast.
...
spellbook-event-summon-ghosts-description =
    Spook the crew out by making them see dead ponies. Be warned, ghosts are capricious and occasionally vindicative, and some will use their incredibly minor abilities to frustrate you.
    This spell goes into effect immediately the moment you buy it.
    Cannot be refunded.
spellbook-event-summon-guns-name = Summon Guns
spellbook-event-summon-guns-description = AK47s for everypony! Places a random gun in front of everypony. Disables refunds when bought!
spellbook-event-summon-magic-name = Summon Magic
spellbook-event-summon-magic-description = Places a random magical item in front of everypony. Nothing could go wrong! Disables refunds when bought!
# Upgrades
