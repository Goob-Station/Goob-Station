...
uplink-holoclown-kit-desc =
    A joint venture between Nightmare Forces and Honk.co. Contains an injector that hosts a sentient metaphysical clown made of hard light which resides in the user's body when not active.
