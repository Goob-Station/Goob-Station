...
uplink-holopara-kit-desc =
    The pride and joy of Nightmare Forces. Contains an injector that hosts a sentient metaphysical guardian made of hard light which resides in the user's body when not active.
...
uplink-holoclown-kit-desc =
    A joint venture between Nightmare Forces and Honk.co. Contains an injector that hosts a sentient metaphysical pinkie pie made of hard light which resides in the user's body when not active.
...
uplink-reinforcement-radio-cyborg-assault-name = Syndicate Assault Robo-Pony Teleporter
...
uplink-chemistry-kit-desc = A starter kit for the aspiring ponyville hospital alchemist, notably includes a chemical payload and timer, a hyperzine syringe, and two vials of vestine for all your criminal needs!
...
uplink-syndicate-jaws-of-life-desc = A combined prying and cutting tool. Useful for entering ponyville or its departments.
...
uplink-chameleon-desc = A backpack full of items that contain chameleon technology allowing you to disguise as pretty much anything on ponyville, and more!
...
uplink-syndicate-sponge-box-desc = A box containing 6 syndicate sponges disguised as monkey pony cubes, these cubes turn into a variety of angry wildlife after coming into contact with water.
...
uplink-costume-clown-name = Pinkie Pie Costume Duffel Bag
uplink-costume-clown-desc = Contains a complete Pinkie Pie outfit. Includes PDA and sugarcube corner radio.
...
uplink-barber-scissors-desc = A good tool to give your fellow agent a nice manecut, unless you want to give it to yourself.
...
uplink-cameraBug-desc = A portable device that allows you to view ponyville's cameras.
...
uplink-business-card-desc = A business card that you can give to someone to demonstrate your involvement in the syndicate or leave at the crime scene in order to make fun of the royal guard detective. You can buy no more than three of them.
