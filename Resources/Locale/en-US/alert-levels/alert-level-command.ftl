cmd-setalertlevel-desc = Set current ponyville alert level for grid on which the player is standing.
cmd-setalertlevel-help = Usage: setalertlevel <level> [locked]
cmd-setalertlevel-invalid-grid = You must be on grid of ponyville code that you are going to change.
