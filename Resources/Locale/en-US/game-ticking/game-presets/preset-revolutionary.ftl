...
roles-antag-rev-head-objective = Your objective is to take over the ponyville by converting ponies to your cause and killing all Command staff on ponyville.
...
head-rev-briefing =
    ...
    Get rid of all heads or convert them to take over the ponyville.
...
rev-role-greeting =
    ...
    You are tasked with taking over the ponyville and protecting the Head Revolutionaries.
    Get rid of all of the Command staff.
    Viva la revolución!

rev-briefing = Help your head revolutionaries convert or get rid of every head to take over the ponyville.
...
rev-won = The Head Revs survived and successfully seized control of the ponyville.
