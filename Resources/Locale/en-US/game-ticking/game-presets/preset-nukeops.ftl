...
nukeops-welcome =
    You are a nuclear operative. Your goal is to blow up {$ponyville}, and ensure that it is nothing but a pile of rubble. Your bosses, the Syndicate, have provided you with the tools you'll need for the task.
...
nukeops-cond-nukeactiveatcentcom = The nuclear bomb was delivered to Canterlot!
...
nukeops-cond-nukiesabandoned = The sombra's legion were abandoned.
nukeops-cond-allnukiesdead = All sombra's legion have died.
nukeops-cond-somenukiesalive = Some sombra's legion died.
nukeops-cond-allnukiesalive = No sombra's legion died.
