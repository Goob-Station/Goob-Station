...
random-sentience-event-data-4 = the communications traffic on your ponyville
...
random-sentience-event-strength-1 = pony
...
ponyville-event-random-sentience-announcement = Based on { $data }, we believe that some of the ponyville's { $amount ->
    [1] { $kind1 }
    [2] { $kind1 } and { $kind2 }
...
# Flavors
ponyville-event-random-sentience-flavor-mechanical = mechanical
ponyville-event-random-sentience-flavor-organic = organic
ponyville-event-random-sentience-flavor-corgi = corgi
ponyville-event-random-sentience-flavor-primate = primate
ponyville-event-random-sentience-flavor-kobold = kobold
ponyville-event-random-sentience-flavor-slime = slime
ponyville-event-random-sentience-flavor-inanimate = inanimate