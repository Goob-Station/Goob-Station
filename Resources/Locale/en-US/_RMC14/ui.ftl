...
rmc-ui-shoutout-nt-title = Name to use for the round-end Equestria shoutout.
rmc-ui-shoutout-nt-description = Displayed at round end as "Equestria funded by: " then your name.
...
rmc-ui-shoutout-nt = [bold]Equestria funded by: [color=green]{ $name }[/color]![/bold]
