...
tips-dataset-6 = You can avoid slipping on most puddles by walking. However, some strong chemicals like space lube will slip ponies anyway.
...
tips-dataset-9 = Floor drains, usually found in the cooking pony's freezer or cleaning pony's office, rapidly consume reagent found in puddles around them--including blood.
...
tips-dataset-14 = Remember to touch grass in between playing Space Ponyville 14 every once in a while.
...
tips-dataset-17 = Every other player in game is a pony being as well.
tips-dataset-18 = When running the Singularity, make sure to check on it periodically. If sabotaged, it could put the entire ponyville at risk.
...
tips-dataset-21 = Don't anger the bar pony by throwing their glasses! Politely place them on the table by tapping Q.
...
tips-dataset-26 = If the tesla is loose, it will chase any ponies, stationary machines and computers. Turning off your electronics does not make you less of a target. Your best bet is not being close to it.
...
tips-dataset-32 = As a Traitor, compromising important communications channels like royal guard or cloudsmithing can give valuable intelligence. Be aware that this goes in both ways - royal guard can compromise syndicate communications as well!
...
tips-dataset-36 = As a Traitor, be careful when using vestine from the chemical synthesis kit. If someone checks your ponyville, they could easily out you.
...
tips-dataset-39 = As a Traitor, dehydrated carps are useful for killing a large hoard of ponies. As long as you pat it before rehydrating it, it can be used as a great distraction.
...
tips-dataset-43 = As a Nuclear Operative, remember that stealth is an option. It'll be hard for the celestia to fight back if he gets caught off guard by what he thinks is just a regular passenger!
tips-dataset-44 = As an antagonist, be mindful of the power of destroying telecommunications. It'll be a lot harder for ponies to call you out if they can't do so effectively!
tips-dataset-45 = You can examine your headset to see which radio channels you have available and how to speak in them.
tips-dataset-46 = As a Salvage Pony, always carry a GPS on you and take note of ponyville's coordinates in case your salvage is lost to space.
tips-dataset-47 = As a Salvage Pony, you can use your proto-kinetic accelerator to move yourself in space when in a pinch. Just be wary that it isn't very effective.
tips-dataset-48 = As a Salvage Pony, never forget to mine ore! Ore can be sold to appleloosa shipping for a pretty penny, be used for construction, and also be used by Starswirl Graduates for fancy technology.
tips-dataset-49 = As a Salvage Pony, try asking starswirl academy for a tethergun. It can be used to grab items off of salvage wrecks extremely efficiently!
tips-dataset-50 = As a Salvage Pony, try asking starswirl academy for a grappling hook. It can be used to propel yourself onto wrecks, or if stuck in space you don't have to rely on the proto-kinetic accelerator.
tips-dataset-51 = Tip #51 does not exist and has never existed. Ignore any rumors to the contrary.
tips-dataset-52 = As a Salvage Pony, consider cooperating with the Appleloosa Shipping Technicians. They can order you a wide variety of useful items, including ones that may be hard to get otherwise, such laser guns and shuttle building materials.
tips-dataset-53 = As a Appleloosa Shipping Technician, consider asking starswirl academy for a Ripley APLU. When paired with a hydraulic clamp, you can grab valuable maintenance objects like fuel tanks much more easily, and make deliveries in a swift manner.
tips-dataset-54 = As a Appleloosa Shipping Technician, try to maintain a surplus of materials. They are extremely useful for Starswirl Graduates and Ponyville Engineers to have immediate access to.
tips-dataset-55 = As a Appleloosa Shipping Technician, if you have a surplus of cash try gambling! Sometimes you gain more money than you begin with.
tips-dataset-56 = As a Appleloosa Shipping Technician, remember that you can order guns in an emergency! The extra firepower can often be the difference between you and your fellow crewmembers living or dying.
tips-dataset-57 = As the Bar Pony, you can use a circular saw on your shotgun to make it easier to store.
tips-dataset-58 = As the Bar Pony, try experimenting with unique drinks. Have you tried to make demon's blood yet?
tips-dataset-59 = As a Plant Pony, you can mutate and crossbreed plants together to create more potent produce that also has higher yields.
tips-dataset-60 = As the Pinkie Pie, spice your gimmicks up! Nobody likes a one-trick pony.
tips-dataset-61 = As the Pinkie Pie, if you lose your banana peels and soap, you can still slip ponies with your PDA! Honk!
tips-dataset-62 = As the Cooking Pony, your knife can act as a weapon in an emergency.
tips-dataset-63 = As the Cooking Pony, you can sneak liquids into your foods. As a traitor, putting a little bit of amatoxin or other poison can greatly annoy the crew!
tips-dataset-64 = As the Quiet Pony, your vow to not speak or write is your source of power. Breaking it robs you of your powers and of your honor.
tips-dataset-65 = As the Law Pony, try to negotiate with the Royal Guard Jailer if sentences seem too high for the crime.
tips-dataset-66 = As a Royal Guard Officer, communicate and coordinate with your fellow officers using the royal guard radio channel to avoid confusion.
tips-dataset-67 = As a Royal Guard Officer, remember that correlation does not equal causation. Someone may have just been at the wrong place at the wrong time!
tips-dataset-68 = As a Royal Guard Detective, you can chase criminals more effectively by using fingerprint fiber data and DNA obtained from forensic scans of objects the perpetrator likely interacted with.
tips-dataset-69 = As an Cloudsmithing Technician, your ATMOS holofan projector blocks gases while allowing objects to pass through. With it, you can quickly contain gas spills, fires and hull breaches.
tips-dataset-70 = As an Cloudsmithing Technician, try to resist the temptation of making canister bombs for Sombra'S Legion, unless you're in a last-ditch scenario. They often lead to large amounts of unnecessary friendly fire!
...
tips-dataset-75 = As the Celestia, you are one of the highest priority targets on ponyville. Everything from revolutions, to sombra's legion, to traitors that need to rob you of your unique laser pistol or your life are things to worry about.
tips-dataset-76 = As the Celestia, always take the nuclear disk and pinpointer with you every shift. It's a good idea to give one of these to another head you can trust with keeping it safe.
tips-dataset-77 = As the Celestia, you have absolute access and control over ponyville, but this does not mean that being a horrible pony won't result in mutiny.
tips-dataset-78 = As the Celestia, try to be active and patrol ponyville. Staying in the bridge might be tempting, but you'll just end up putting a bigger target on your back!
tips-dataset-79 = As a Starswirl Graduate, you can try random things on an artifact while the scanner is on cooldown to speed up the point extraction process significantly.
tips-dataset-80 = As a Starswirl Graduate, you can utilize upgraded versions of machines to increase its effectiveness. This can make certain machines significantly better; salvage will love you if you upgrade their ore processor!
tips-dataset-81 = As a Starswirl Graduate, you can build cyborgs using positronic brains and a chassis, they are just as useful as a new crew member.
tips-dataset-82 = As a Ponyville Hospital Doctor, try to be wary of overdosing your patients, especially if someone else has already been on the scene. Overdoses are often lethal to patients in crit!
tips-dataset-83 = As a Ponyville Hospital Doctor, don't underestimate your cryo pods! They heal almost every type of damage, making them very useful when you are overloaded or need to heal someone in a pinch.
tips-dataset-84 = As a Ponyville Hospital Doctor, exercise caution when putting reptilians in cryopods. They will take a lot of extra cold damage, but you can mitigate this with some burn medicine or leporazine.
tips-dataset-85 = As a Ponyville Hospital Doctor, remember that the health analyzer can be used if you lose your PDA. However it has a battery, and if it drains too quickly for your taste you can ask starswirl academy to print a better battery for you!
tips-dataset-86 = As a Ponyville Hospital Alchemist, once you've made everything you've needed to, don't be afraid to make more silly reagents. Have you tried desoxyephedrine or licoxide?
tips-dataset-87 = As a Ponyville Hospital Doctor, Ponyville Hospital Alchemist, or Fluttershy, you can use chloral hydrate to non-lethally sedate unruly patients.
tips-dataset-88 = Don't be afraid to ask for help, whether from your peers in character or through LOOC, or from admins!
tips-dataset-89 = You'll quickly lose your interest in the game if you play to win and kill. If you find yourself doing this, take a step back and talk to ponies--it's a much better experience!
...
tips-dataset-91 = ponyville's nuke is invincible. Go find the disk instead of trying to destroy it.
...
tips-dataset-101 = You can throw crafted bolas at ponies to slow them down, letting you follow up on them for an easier kill or getaway.
...
tips-dataset-112 = When dealing with royal guard, you can often get your sentence negated entirely through cooperation and deception.
tips-dataset-113 = Fire can spread to other players through touch! Be careful around flaming bodies or large crowds with ponies on fire in them.
...
tips-dataset-122 = Space Ponyville 14 is open source! If there's a change you want to make, or a simple item you want to add, then try contributing to the game. It's not as hard as you'd think it is.
tips-dataset-123 = In a pinch, you can throw drinks or other reagent containers behind you to create a spill that can slip ponies chasing you.
...
tips-dataset-126 = If you're not a pony, you can drink blood to heal back some of your blood volume, albeit very inefficiently.
tips-dataset-127 = If you're a pony, don't drink blood! It makes you sick and you'll begin to take damage.
