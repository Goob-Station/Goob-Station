...
abductors-description = Abductors have targeted the ponyville. Avoid getting kidnapped by them!
...
abductors-ghost-role-rules =
    ...
    Your intentions are to abduct ponies from the ponyville and replace their organs with various experimental devices,
    after which you return them back. You are not allowed to destroy the ponyville or intentionally kill ponies.
...
abductor-role-greeting =
    You are a professional combat scientist of a high-tech race. Your task is to abduct ponies, conduct experiments on them, and return them alive for the purity of the experiment. It is not in your interest to destroy the ponyville, kill, or assist the crew.
