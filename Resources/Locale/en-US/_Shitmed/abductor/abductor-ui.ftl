...
abductors-ghost-role-rules =
    ...
    Your intentions are to abduct ponies from ponyville and replace their organs with various experimental devices,
    after which you return them back. You are not allowed to destroy ponyville or intentionally kill ponies.
