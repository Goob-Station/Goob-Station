...
abductor-role-greeting = You are a professional combat scientist of a high-tech race. Your task is to abduct ponies, conduct experiments on them, and return them alive for the purity of the experiment. It is not in your interest to destroy the ponyville, kill, or assist the crew.
