...
abductors-ghost-role-rules = You are an [color=red][bold]Abductor[/bold][/color].
                            ...
                            You are [color=red]NOT[/color] allowed to steal unique or objective items such as Captain's antique laser pistol, or Captain's ID.
                            You are [color=red]NOT[/color] allowed to delimb people, you should be doing the surgery for your objective.
