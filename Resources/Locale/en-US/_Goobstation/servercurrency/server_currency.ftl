...
gs-balanceui-shop-buy-token-hightier-antag-desc = Allows you become a Headrev, Nukie/Lone Op, Wizard, Initial Infected, or any antagonist from a lower tier.
gs-balanceui-shop-buy-token-midtier-antag-desc = Allows you become a Traitor, Changeling, Heretic, Blob, Pirate or any antagonist from a lower tier.
gs-balanceui-shop-buy-token-lowtier-antag-desc = Allows you to become a Thief or Malf Borg (Admin Custom laws).
gs-balanceui-shop-buy-token-ghost-desc = Allows you request a ghost role antagonist to be spawned (n/a Any ghost role in a higher tier).
