...
## stage 5
knowledge-path-side-s5-armor-name = Armorer’s Ritual
knowledge-path-side-s5-armor-desc =
...
knowledge-path-side-s5-flask-name = Priest's Ritual
knowledge-path-side-s5-flask-desc =
...
knowledge-path-side-s5-ashen-eyes-name = Ashen Eyes
knowledge-path-side-s5-ashen-eyes-desc =
...
knowledge-path-side-s5-void-cloak-name = Void Cloak
knowledge-path-side-s5-void-cloak-desc =
...
knowledge-path-side-s5-shark-name = Scorching Shark
knowledge-path-side-s5-shark-desc =
...
## stage 7
knowledge-path-side-s7-ice-spear-name = Mysteries of Creation
knowledge-path-side-s7-ice-spear-desc =
...
knowledge-path-side-s7-rustwalker-name = Rusted Ritual
knowledge-path-side-s7-rustwalker-desc =
...
knowledge-path-side-s7-morbus-name = Codex Morbus
knowledge-path-side-s7-morbus-desc =
