...
knowledge-path-blade-s1-desc =
    ...
    Follow the path of blades. Transmute a knife with a bar of silver into a sundered blade.
...
knowledge-path-blade-s3-desc =
    ...
    Being attacked while wielding a Heretic Blade in either hand will deliver a riposte towards your attacker. This effect can only trigger once every 20 seconds.
...
knowledge-path-blade-s4-desc =
    ...
    While marked, the victim will be trapped with you in a confined space until it expires or is triggered.
...
knowledge-path-blade-s7-desc =
    ...
    Grants resilience to blood loss from wounds and immunity to having your limbs dismembered.
...
knowledge-path-blade-s8-name = Empowered Blades
knowledge-path-blade-s8-desc =
    ...
    You are able to infuse your mansus grasp directly into your blades, giving them more overall damage and efficiency against structures.
    Attacking someone with a Sundered Blade in both hands will now deliver a blow with both at once, dealing two attacks in rapid succession. The second blow will be slightly weaker.
...
knowledge-path-blade-s10-desc =
    ...
    Additionally, you become a master of combat, gaining bleeding immunity and the ability to shrug off stuns.
