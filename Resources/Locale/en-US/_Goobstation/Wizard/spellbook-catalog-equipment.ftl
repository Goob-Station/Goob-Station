...
spellbook-scrying-orb-desc = An incandescent orb of crackling energy, using it will allow you to ghost while alive, allowing you to spy upon the ponyville with ease. In addition, holding it in your hand or in your pocket will grant you x-ray vision.
...
spellbook-paper-robe-desc = Special discord robes that allow the user to summon angry stick minions to aid them in battle
