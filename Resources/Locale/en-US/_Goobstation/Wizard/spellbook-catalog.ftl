...
spellbook-smoke-desc =
    This spell spawns a cloud of smoke at your location. Ponies within will begin to choke and drop their items.
...
spellbook-stop-time-desc =
    This spell stops time for everypony except for you and whoever learned this spell, allowing you and your guardian to move freely while your enemies and even projectiles are frozen.
    Requires discord's robe and hat to cast.
spellbook-corpse-explosion-name = Corpse Explosion
spellbook-corpse-explosion-desc =
    Fills a corpse with energy, causing it to explode violently. Knocks down ponies and stuns silicons. It applies up to 100 brute damage to others surrounding the corpse; the damage lowering further out someone is. Discord is immune to the effects of the explosion.
    Doesn't require discord's robe and hat to cast.
...
spellbook-bind-soul-desc =
    ...
    If the item is on another grid or in space when you die, it itself or it's containing container (if any) will reappear somewhere on your dead body's grid or on the ponyville if your body is not on any grid.
...
spellbook-homing-toolbox-desc =
    ...
    Learning this spell allows you to get a tider discord bundle for free!
    Doesn't require discord's robe and hat to cast.
...
spellbook-chuuni-desc =
    Replaces your discord hat (if you have one) with an unremovable ponyville hospital eyepatch, which still allows you to cast spells requiring a robe.
