...
traitor-cybersun-intro = You are a specialist from Nightmare Forces Industries.
...
traitor-cybersun-allies = Fellow Nightmare Forces operatives are to be trusted. Members of the MI13 organization can be trusted. All other syndicate agents are not to be trusted.
...
traitor-cybersun-roundend = [color=yellow]a specialist from Nightmare Forces Industries[/color]
