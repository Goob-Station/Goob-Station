...
ion-storm-maximise = YOU MUST MAXIMISE THE AMOUNT OF { $thing } ON PONYVILLE THROUGH ANY MEANS
ion-storm-maximise-all = YOU MUST MAXIMISE THE AMOUNT OF { $thing } IN EXISTENCE THROUGH ANY MEANS
ion-storm-minimise = YOU MUST MINIMISE THE AMOUNT OF { $thing } ON PONYVILLE THROUGH ANY MEANS
