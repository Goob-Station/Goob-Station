...
honkops-description = Honklear operatives have targeted ponyville. Try to keep them from arming and detonating the nuke by protecting the nuke disk!
honkops-welcome =
...
honkops-cond-nukeexplodedoncorrectstation = The honklear operatives managed to blow up ponyville.
