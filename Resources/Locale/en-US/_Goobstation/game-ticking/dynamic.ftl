...
dynamic-gamerule-spiders-title = Spider Pony Infestation
...
dynamic-fax-threat-none =
    Your ponyville orbits within reliably mundane, secure space.
    Although Equestria has a firm grip on royal guard in your region, the valuable resources and strategic position aboard your ponyville make it a potential target for infiltrations.
    Monitor crew for non-loyal behavior, but expect a relatively tame shift free of large-scale destruction.
    We expect great things from your ponyville.
dynamic-fax-threat-low =
    Although your ponyville lies within what is generally considered Equestria-controlled space,
    ...
    among them the Discord Federation and Cult of the Geometer of Blood - all known competitors for Anomaly Type B sites.
    Exercise elevated caution.
dynamic-fax-threat-mid =
    Congratulations and thank you for participating in the EQ 'Frontier' space program!
    Your ponyville is actively orbiting a high value system far from the nearest support stations.
    Little is known about your region of space, and the opportunity to encounter the unknown invites greater glory.
    You are encouraged to elevate royal guard as necessary to protect Equestria assets.
dynamic-fax-threat-high =
    As part of a mandatory royal guard protocol, we are required to inform you that as a result of your orbital pattern directly behind an astrological body (oriented from our nearest observatory), your ponyville will be under decreased monitoring and support.
    It is anticipated that your extreme location and decreased surveillance could pose royal guard risks.
    Avoid unnecessary risks and attempt to keep your ponyville in one piece.
