...
ghost-role-information-blob-description = You are the Blob Infection. Consume ponyville.
...
blob-alert-out-off-station = The blob was removed because it was found outside ponyville!
# Announcment
blob-alert-recall-shuttle = The emergency shuttle can not be sent while there is a level 5 biohazard present on ponyville.
blob-alert-detect = Confirmed outbreak of level 5 biohazard aboard ponyville. All personnel must contain the outbreak.
blob-alert-critical = Biohazard level critical, nuclear authentication codes have been sent to ponyville. Canterlot orders any remaining personnel to activate the self-destruction mechanism.
...
blob-carrier-role-rules =
    You are an antagonist. You have 4 minutes before you transform into a blob.
    Use this time to find a safe spot on ponyville. Keep in mind that you will be very weak right after the transformation.
blob-carrier-role-greeting = You are a carrier of Blob. Find a secluded place at ponyville and transform into a Blob. Turn ponyville into a mass and its inhabitants into your servants. We are all Blobs.
# Verbs
...
blob-zombie-greeting = You were infected and raised by a blob spore. Now you must help the blob take over ponyville. Use +e in chat to talk in the Blobmind.
# End round
...
# Objectivies
objective-condition-blob-capture-title = Take over ponyville
