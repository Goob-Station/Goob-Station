...
gun-spin-fail-self = You mess up and fumble {THE($weapon)}, you feel like an total idiot!
gun-spin-fail-others = {$user} messes up and fumbles {THE($weapon)}, what an idiot!

gun-spin-complete-self = You successfully stop spinning {THE($weapon)}, you feel like a total badass!
