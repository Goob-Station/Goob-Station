...
selectable-set-duty-weapon-mk58-lethal-desc =
    ...
    Chambered in .35 auto, it comes with 1 magazine of lethal ammuniton.
    WARNING: UNIT WILL DROP PRODUCT ON FLOOR, APPROVE IN SECURE AREA

selectable-set-duty-weapon-mk58-non-lethal-name = Mk58 [Non-Lethal]
selectable-set-duty-weapon-mk58-non-lethal-desc =
    Almost as cheap as it is famous, this is THE pistol on NanoTrassen stations.
    Chambered in .35 auto, it comes with 2 magazines of non-lethal ammuniton.
    WARNING: UNIT WILL DROP PRODUCT ON FLOOR, APPROVE IN SECURE AREA
...
selectable-set-duty-weapon-salvinn-desc =
    ...
    Comes with 2 small batteries, but you can use your own too!
    WARNING: UNIT WILL DROP PRODUCT ON FLOOR, APPROVE IN SECURE AREA
