...
hos-box-category-sniper-description =
    An elaborately designed sniper rifle,
    firing shots of pure phoron.
    You won't want to get hit by this.

hos-box-category-equipment-name = Devtest Placeholder
hos-box-category-equipment-description =
    This is just a placeholder. It contains every advanced HOS gear piece.
