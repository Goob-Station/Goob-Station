...
ui-options-function-voice-push-to-talk = Voice Push-to-Talk

ui-escape-voice-chat = Voice Chat

cmd-voicechat-desc = Opens the voice chat page in your browser
cmd-voicechat-help = Usage: voicechat
cmd-voicechat-opening = Opening voice chat in your browser. Keep the tab open while you play.
