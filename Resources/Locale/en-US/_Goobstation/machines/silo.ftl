...
signal-port-description-material-silo = Bluespace storage for ponyville materials
signal-port-name-material-silo-utilizer = Silo utilizer
signal-port-description-material-silo-utilizer = Utilizer for ponyville material silo
