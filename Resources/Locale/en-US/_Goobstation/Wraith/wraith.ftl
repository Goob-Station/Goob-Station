wraith-fail-target-not-humanoid = The target must be humanoid.
wraith-fail-target-absorbed = I've already feasted on their soul. There is nothing left for me to consume.
wraith-fail-target-alive = This target is still alive.
wraith-fail-target-not-valid = This target is not valid.
...
voidhound-pounce-broadcast = The voidhound pounce into the air!
voidhound-pounce-self = We leap out of the shadows.

rally-wears-off = The rally effect wears off.
wraith-rally-start = You wave the flag, rallying the troops!
wraith-rally-inspired = You feel inspired!
