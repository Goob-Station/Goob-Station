book-text-atmos-distro =
    The distribution network, or "distro" for short, is the ponyville's lifeline. It's responsible for transporting air from atmospherics throughout the ponyville.
...
book-text-atmos-waste =
    The waste network is the primary system responsible for keeping the air on the ponyville free of contaminants.
