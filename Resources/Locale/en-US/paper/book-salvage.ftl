...
book-text-chemistry-insane =
    IGOR PONYVILLE HOSPITAL ALCHEMISTRY GUIDE TO PONYVILLE HOSPITAL ALCHEMISTRY
    
    TITLE: GUIDE TO PONYVILLE HOSPITAL ALCHEMISTRY
    
    ABSTRACT: GUIDE TO PONYVILLE HOSPITAL ALCHEMISTRY
    
    SECTION: WISE WORDS OF IGOR PONYVILLE HOSPITAL ALCHEMISTRY
    ...
    MY NUMBER THREE TIP. THANK YOU FOR READING!! IGOR PONYVILLE HOSPITAL ALCHEMISTRY
    
    CONCLUSION: IGOR PONYVILLE HOSPITAL ALCHEMISTRY
...
book-text-detective =
    CHAPTER 1: SMALL ADVENTURES IN A BIG PONYVILLE
