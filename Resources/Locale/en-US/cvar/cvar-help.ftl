...
changecvar-simple-events_enabled = Controls if the game should run ponyville events.
changecvar-full-events_enabled = Controls if the game should run ponyville events.
