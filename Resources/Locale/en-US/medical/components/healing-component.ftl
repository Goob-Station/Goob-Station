...
ponyville hospital-item-stop-bleeding-self = You have stopped bleeding
ponyville hospital-item-popup-target = {CAPITALIZE(THE($user))} is trying to heal you with the {$item}!
