...
uplink-experimental-syndicate-teleporter-desc = A self-recharging device that teleports the user 3-8 tiles forward. In case of teleportation into a wall, uses emergency teleportation.
