...
emergency-shuttle-command-dock-desc = Calls the emergency shuttle and docks it to ponyville... if it can.

## Launch emergency shuttle

emergency-shuttle-command-launch-desc = Early launches the emergency shuttle if possible.
# Emergency shuttle
emergency-shuttle-left = The Emergency Shuttle has left ponyville. Estimate { $transitTime } seconds until the shuttle arrives at Canterlot.
emergency-shuttle-launch-time = The emergency shuttle will launch in { $consoleAccumulator } seconds.
emergency-shuttle-docked = The Emergency Shuttle has docked { $direction } of ponyville, { $location }. It will leave in { $time } seconds.{ $extended }
emergency-shuttle-good-luck = The Emergency Shuttle is unable to find a ponyville. Good luck.
emergency-shuttle-nearby = The Emergency Shuttle is unable to find a valid docking port. It has warped in { $direction } of ponyville, { $location }. It will leave in { $time } seconds.{ $extended }
