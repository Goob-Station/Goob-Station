...
command-description-stations-getowningstation = Gets ponyville that a given entity is "owned by" (within)
...
command-description-stations-rerollBounties = Clears all the current bounties for ponyville and gets a new selection.
