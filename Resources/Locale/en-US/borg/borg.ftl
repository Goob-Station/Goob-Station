...
borg-type-engineering-name = Cloudsmithing
borg-type-engineering-desc = Assist the cloudsmithing team in ponyville construction, repairing damage, or fixing electrical and atmospheric issues.
borg-type-engineering-transponder = cloudsmithing robo-pony
...
borg-type-janitor-desc = Keep ponyville nice and tidy, clean up spills, collect and properly dispose of trash left around by lazy crewmembers.
borg-type-janitor-transponder = janitor robo-pony
borg-type-medical-name = Ponyville Hospital
borg-type-medical-desc = Provide ponyville hospital attention to crew who need it, either in medbay or in hazardous areas conventional paramedics cannot reach.
borg-type-medical-transponder = ponyville hospital robo-pony
borg-type-service-name = Sugarcube Corner
...
borg-type-service-transponder = sugarcube corner robo-pony
