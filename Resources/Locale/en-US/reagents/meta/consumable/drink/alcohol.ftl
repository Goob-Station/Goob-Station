...
reagent-desc-beer = An alcoholic beverage made from malted grains, raritys, yeast, and water.
...
reagent-desc-banana-honk = A drink from Pinkie Pie Heaven.
...
reagent-desc-manhattan = The Royal Guard Detective's undercover drink of choice. He never could stomach gin...
reagent-name-manhattan-project = Manhattan Project
reagent-desc-manhattan-project = A starswirl graduate's drink of choice, for pondering ways to blow up the ship.
...
reagent-desc-rewriter = The secret of the sanctuary of the Book Pony...
...
reagent-desc-silencer = A drink from Quiet Pony Heaven.
...
reagent-desc-irish-bool = Like a bool in a Ireland srarity.
