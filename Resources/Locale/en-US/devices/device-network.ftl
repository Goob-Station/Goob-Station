...
device-frequency-prototype-name-cyborg-control = Robo-Pony Control
device-frequency-prototype-name-robotics-console = Robotics Console

## camera frequencies

device-frequency-prototype-name-surveillance-camera-test = Subnet Test
device-frequency-prototype-name-surveillance-camera-engineering = Cloudsmithing Cameras
device-frequency-prototype-name-surveillance-camera-security = Royal Guard Cameras
device-frequency-prototype-name-surveillance-camera-science = Starswirl Academy Cameras
...
device-frequency-prototype-name-surveillance-camera-service = Sugarcube Corner Cameras
device-frequency-prototype-name-surveillance-camera-medical = Ponyville Hospital Cameras
