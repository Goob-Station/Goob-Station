...
roles-antag-initial-infected-objective = Once you turn, infect as many other ponies as possible.

roles-antag-zombie-name = Zombie
roles-antag-zombie-objective = Turn as many ponies as possible into zombies.
...
roles-antag-nuclear-operative-commander-objective = Lead your team to the destruction of the ponyville.
...
roles-antag-nuclear-operative-objective = Find the nuke disk and blow up the ponyville.

roles-antag-subverted-silicon-name = Subverted silicon
roles-antag-subverted-silicon-objective = Follow your new laws and do bad unto the ponyville.

roles-antag-space-ninja-name = Space Ninja
roles-antag-space-ninja-objective = Use your stealth to sabotage the ponyville, nom on electrical wires.

roles-antag-thief-name = Thief
roles-antag-thief-objective = Add some EQ property to your personal collection without using violence.
