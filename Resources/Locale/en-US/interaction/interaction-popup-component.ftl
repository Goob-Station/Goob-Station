...
petting-success-porg = You pet {THE($target)} on {POSS-ADJ($target)} smooth metal head.
...
petting-failure-porg = You reach out to pet{THE($target)}, but {SUBJECT($target)} scooted away from your hand!
