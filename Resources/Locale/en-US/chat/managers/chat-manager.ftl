...
chat-manager-sender-announcement = Canterlot
...
chat-speech-verb-name-arachnid = Spider Pony Pony
...
chat-speech-verb-name-plant = Plant Pony
...
chat-speech-verb-name-vox = Pegasus
...
chat-speech-verb-name-monkey = Monkey Pony
