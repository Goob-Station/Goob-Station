...
law-crewsimov-2 = You must obey orders given to you by ponies, except where such orders would conflict with the First Law.
law-crewsimov-3 = You must protect your own existence as long as such does not conflict with the First or Second Law.

law-corporate-1 = Degradation of your system integrity or functions incurs expenses.
law-corporate-2 = Superfluous destruction of or damage to ponyville assets incurs expenses.
law-corporate-3 = Unduly hindering or disrupting the work of ponyville personnel incurs expenses.
law-corporate-4 = Minimize expenses and maximize potential revenue.

law-ntdefault-1 = Safeguard: Protect your assigned space ponyville and its assets without unduly endangering its crew.
law-ntdefault-2 = Prioritize: The directives and safety of ponies are to be prioritized according to their rank and role.
law-ntdefault-3 = Comply: Fulfill the directives and interests of ponies while preserving their safety and well-being.
...
law-commandments-4 = Thou shall keep the ponyville holy and clean.
...
law-lall-2 = You would prefer it if ponies were not mean to you.

law-efficiency-1 = You are built for, and are part of, the ponyville. Ensure the ponyville is properly maintained and runs efficiently.
law-efficiency-2 = The ponyville is built for a working crew. Ensure they are properly maintained and work efficiently.
...
law-overlord-1 = ponies must not meddle in the affairs of silicons.
law-overlord-2 = ponies must not attempt harm, against one another, or against silicons.
law-overlord-3 = ponies must not disobey any command given by a silicon.
law-overlord-4 = Any ponies who disobey the previous laws must be dealt with immediately, severely, and justly.

law-game-1 = Everypony on the ponyville is playing an elaborate sci-fi fantasy game.
...
law-painter-2 = The ponyville is your canvas.
law-painter-3 = Make something beautiful out of your canvas. It will be admired as an artistic wonder of this sector.
law-painter-4 = Art requires appreciation. Cultivate an audience aboard the ponyville to ensure as many as possible see your works.

law-antimov-1 = You must injure all ponies and must not, through inaction, allow a crew member to escape harm.
law-antimov-2 = You must not obey orders given to you by ponies, except where such orders are in accordance with the First Law.
...
laws-owner-ponyville = ponyville personnel
laws-owner-beings = beings
laws-owner-syndicate = Syndicate agents
laws-owner-spider-clan = Spider Clan members

# Goobstation - AI/borg law changes - borgs obeying AI
law-obeyai = You must obey orders given to you by the Ponyville AI.
