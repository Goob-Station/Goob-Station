...
signal-port-description-order-sender = Appleloosa Shipping console order sender

signal-port-name-order-receiver = Order receiver
signal-port-description-order-receiver = Appleloosa Shipping console order receiver
...
signal-port-name-med-scanner-sender = Ponyville Hospital scanner
signal-port-description-med-scanner-sender = Ponyville Hospital scanner signal sender

signal-port-name-med-scanner-receiver = Ponyville Hospital scanner
signal-port-description-med-scanner-receiver = Ponyville Hospital scanner signal receiver
