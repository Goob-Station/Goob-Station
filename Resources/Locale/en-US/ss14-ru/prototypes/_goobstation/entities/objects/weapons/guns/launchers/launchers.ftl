ent-WeaponLauncherNonLethal = GL-06 RGL
  .desc = A single shot, break action riot grenade launcher designed for crowd control and law enforcement use. The built in safety prevents the use of lethal grenades.
