...
ent-ClothingHeadHelmetHardsuitGoliath = goliath hardsuit helmet
  .desc = A sturdy hardsuit helmet, infused with a goliath's hide and an eerie, unblinking eye cut from its mass. # Goob edit
...
ent-ClothingHeadHelmetHardsuitWarden = warden's hardsuit helmet # Goob edit
  .desc = A modified riot helmet. Oddly comfortable.

ent-ClothingHeadHelmetHardsuitCap = captain's spacesuit helmet # Goob edit
  .desc = Special spacesuit helmet, made for the captain of the station.

ent-ClothingHeadHelmetHardsuitEngineeringWhite = chief engineer's hardsuit helmet # Goob edit
  .desc = Special hardsuit helmet, made for the chief engineer of the station.

ent-ClothingHeadHelmetHardsuitMedical = chief medical officer's hardsuit helmet # Goob edit
  .desc = Lightweight medical hardsuit helmet that doesn't restrict your head movements. # Goob edit

ent-ClothingHeadHelmetHardsuitRd = experimental research hardsuit helmet
  .desc = Lightweight hardsuit helmet that doesn't restrict your head movements. # Goob edit

ent-ClothingHeadHelmetHardsuitSecurityRed = head of security's hardsuit helmet # Goob edit
...
ent-ClothingHeadHelmetHardsuitLuxury = luxury mining hardsuit helmet
  .desc = A refurbished mining hardsuit helmet, fitted with satin cushioning and an extra (non-functioning) antenna, because you're that extra. # Goob edit
...
ent-ClothingHeadHelmetHardsuitSyndieElite = syndicate elite hardsuit helmet
  .desc = An elite version of the blood-red hardsuit's helmet, with improved armor and fireproofing. Property of Gorlex Marauders. # Goob edit

ent-ClothingHeadHelmetHardsuitSyndieCommander = syndicate hardsuit helmet
  .desc = A bulked up version of the blood-red hardsuit's helmet, purpose-built for the commander of a syndicate operative squad. Has significantly improved armor for those deadly front-lines firefights. # Goob edit
...
ent-ClothingHeadHelmetHardsuitPirateCap = pirate captain's hardsuit helmet # Goob edit
...
ent-ClothingHeadHelmetHardsuitSanta = Santa's hardsuit helmet # Goob edit
