...
ent-BruteAutoInjector = brute auto-injector
    .desc = A rapid dose of bicaridine, salicylic acid, and tranexamic acid, intended for combat applications. Usage of multiple highly recommended against.
ent-BurnAutoInjector = burn auto-injector
    .desc = A rapid dose of oxandrolone and leporazine, intended for combat applications.
