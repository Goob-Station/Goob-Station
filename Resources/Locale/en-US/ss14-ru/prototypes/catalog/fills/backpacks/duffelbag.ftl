...
ent-ClothingBackpackDuffelSyndicateAmmoFilled = ammo bundle
    .desc = Reloading! Contains 4 magazines for the C-20r, 5 drums for the Bulldog, 2 ammo boxes for the L6 SAW, and 3 mags for the Burner.
...
ent-ClothingBackpackDuffelSyndicateHardsuitBundle = syndicate voidsuit bundle
    .desc = Contains the Syndicate's signature blood red voidsuit.
ent-ClothingBackpackDuffelSyndicateEliteHardsuitBundle = syndicate elite voidsuit bundle
    .desc = Contains the Syndicate's elite voidsuit, which comes with some more stuff in it.
