...
comms-console-menu-announcement-button-tooltip = Send your message as a ponyville-wide radio announcement.
comms-console-menu-broadcast-button = Broadcast
comms-console-menu-broadcast-button-tooltip = Broadcast your message to wall-mounted screens around the ponyville. Note: They fit only ten characters!
comms-console-menu-alert-level-button-tooltip = Change the ponyville alert level. Applies immediately on selecting.
...
comms-console-announcement-title-ponyville = Communications Console
comms-console-announcement-title-canterlot = Canterlot
comms-console-announcement-title-nukie = Syndicate Nuclear Operative
comms-console-announcement-title-ponyville-ai = Ponyville AI
