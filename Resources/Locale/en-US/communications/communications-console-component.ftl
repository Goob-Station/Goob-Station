...
comms-console-menu-broadcast-button-tooltip = Broadcast your message to wall-mounted screens around ponyville. Note: They fit only ten characters!
comms-console-menu-alert-level-button-tooltip = Change ponyville alert level. Applies immediately on selecting.
