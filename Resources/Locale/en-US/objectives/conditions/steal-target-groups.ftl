...
steal-target-groups-celestia-id-card = celestia ID card
steal-target-groups-jetpack-celestia-filled = celestia's jetpack
...
steal-target-groups-ponyville hospital-tech-fab-circuitboard = ponyville hospital techfab machine board
steal-target-groups-clothing-headset-alt-ponyville hospital = chief ponyville hospital officer's over-ear headset
...
steal-target-groups-appleloosa shipping-shuttle-console-circuitboard = appleloosa shipping shuttle console board
...
steal-target-groups-altar-equestria = equestria altar (any)

steal-target-groups-nuclear-bomb = nuclear fission explosive
steal-target-groups-fax-machine-celestia = celestia long range fax machine
