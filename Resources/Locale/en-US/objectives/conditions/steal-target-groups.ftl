...
steal-target-groups-captain-id-card = celestia ID card
steal-target-groups-jetpack-captain-filled = celestia's jetpack
...
steal-target-groups-cargo-shuttle-console-circuitboard = appleloosa shipping shuttle console board
...
steal-target-groups-altar-nanotrasen = equestria altar (any)
steal-target-groups-nuclear-bomb = nuclear fission explosive
steal-target-groups-fax-machine-captain = celestia long range fax machine
