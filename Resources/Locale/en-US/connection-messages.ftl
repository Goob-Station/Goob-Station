...
ipintel-region-whitelist = This server is region locked, and your connected has been blocked. Only the following countries are allowed to connect to this server: {$regions}. If you believe this to be a mistake, contact the adminstration team of the server for assistance.
