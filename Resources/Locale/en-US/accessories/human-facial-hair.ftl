...
marking-HumanFacialHairBrokenman = Beard (Broken Pony)
marking-HumanFacialHairChin = Beard (Chinstrap)
marking-HumanFacialHairDwarf = Beard (Short Pony)
...
marking-HumanFacialHairMutton = Sideburns (Mutton Craritys)
