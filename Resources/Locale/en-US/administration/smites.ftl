...
admin-smite-monkeyify-description = Turns the target into a monkey pony.
...
admin-smite-pinball-description = Turns them into a super bouncy ball, flinging them around until they clip through ponyville into the abyss.
...
admin-smite-cluwne-description = Cluwnes them. The suit cannot be removed and ponyville's crew may murder them freely.
...
admin-smite-reptilian-species-swap-description = It changes their species to Reptilian. Useful for ponies who were being space racist.
...
admin-smite-maid-description = Forcibly converts them into a cleaning ponyial cat maid. This is actual torture for some players, use it wisely.
...
admin-smite-super-bonk-description = Slams them on every single table on ponyville and beyond.
admin-smite-super-bonk-lite-description = Slams them on every single table on ponyville and beyond. Stops when the target is dead.
...
admin-trick-bar-job-slots-description = Closes all job slots on ponyville, such that nobody can join it.
admin-trick-locate-cargo-shuttle-description = Teleports you directly to ponyville's appleloosa shipping shuttle, if it exists.
admin-trick-infinite-battery-description = Reconfigures the SMESes and substations on the grid/ponyville/map to self-recharge rapidly.
