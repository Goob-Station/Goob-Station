...
admin-smite-pinball-description = Turns them into a super bouncy ball, flinging them around until they clip through the ponyville into the abyss.
...
admin-smite-cluwne-description = Cluwnes them. The suit cannot be removed and the ponyville's crew may murder them freely.
...
admin-smite-super-bonk-description = Slams them on every single table on the Ponyville and beyond.
admin-smite-super-bonk-lite-description= Slams them on every single table on the Ponyville and beyond. Stops when the target is dead.
...
admin-trick-bar-job-slots-description = Closes all job slots on the ponyville, such that nobody can join it.
admin-trick-locate-appleloosa shipping-shuttle-description = Teleports you directly to the ponyville's appleloosa shipping shuttle, if it exists.
