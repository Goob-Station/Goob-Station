...
mail-locked = Замок захисту від втручання не знято. Торкніться ID-картки одержувача.
...
command-mailnow = Примусити всі поштові телепорти доставити наступну партію пошти якомога швидше. Це не обійде ліміт недоставленої пошти.
