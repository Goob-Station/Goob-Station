admin-manager-self-de-admin-message = {$exAdminName} деадмінував себе.
admin-manager-self-re-admin-message = {$newAdminName} переадмінував себе.
...
admin-manager-admin-logout-message = Логаут адміністратора: {$name}
