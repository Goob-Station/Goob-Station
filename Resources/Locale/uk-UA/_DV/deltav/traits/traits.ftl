...
trait-ultravision-desc = Чи то через спеціальні біонічні очі, випадкову мутацію,
                         чи будучи Гарпією, ви сприймаєте світ в ультрафіолетовому світлі.

trait-deuteranopia-name = Дейтеранопія
trait-deuteranopia-desc = Чи то через спеціальні біонічні очі, випадкову мутацію,
