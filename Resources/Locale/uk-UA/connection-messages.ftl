...
ipintel-server-ratelimited = Цей сервер використовує систему аудиту із зовнішньою верифікацією, але сервер досяг максимального ліміту перевірок у зовнішньому сервісі. Зверніться до адміністрації сервера, щоб повідомити про це й отримати подальшу допомогу, або спробуйте пізніше.
ipintel-unknown = Цей сервер використовує систему аудиту із зовнішньою верифікацією, але під час перевірки вашого з'єднання сталася помилка. Зверніться до адміністрації сервера, щоб повідомити про це й отримати подальшу допомогу, або спробуйте пізніше.
ipintel-suspicious = Схоже, ви намагаєтеся підключитися через датацентр, проксі, VPN або інше підозріле з'єднання. З адміністративних причин ми не дозволяємо грати з такими підключеннями. Якщо у вас увімкнений VPN або подібний сервіс, вимкніть його й спробуйте підключитися знову, або зверніться до адміністрації сервера по допомогу, якщо вважаєте це помилкою чи вам потрібно використовувати такі сервіси для гри.
