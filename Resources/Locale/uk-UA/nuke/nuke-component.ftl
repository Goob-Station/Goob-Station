...
nuke-component-announcement-armed = Увага! Механізм самознищення станції було увімкнено {$position}. {$time} секунд до детонації. Якщо це було зроблено помилково, механізм може бути розміновано.
