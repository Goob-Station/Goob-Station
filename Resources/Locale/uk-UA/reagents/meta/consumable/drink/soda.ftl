...
reagent-desc-energy-drink = Нанотрейзен радіє, що ти вибрав не спати, а працювати!
...
reagent-desc-pwr-game = Коли геймер каже про заправку геймера, це те, про що вони кажуть.

reagent-name-root-beer = корневе пиво
reagent-desc-root-beer = Cмачний газований напій, добре смакує з морозивом!
...
reagent-desc-shamblers-juice = ~Налий-но мені ще того Соку Шамблерів!~
