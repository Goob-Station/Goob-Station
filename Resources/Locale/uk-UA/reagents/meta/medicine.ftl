...
reagent-desc-lacerinol = Досить нереактивна хімічна речовина, що підвищує синтез колагену до неймовірного рівня, загоюючи різані травми.
...
reagent-name-dexalin-plus-saline = дексалін плюс і фізрозчин
reagent-name-puncturase-tranexamic = пунктураза і транексамова кислота
reagent-name-pyrazine-dermaline = піразин і дермалін
reagent-name-arcryox = аркріокс
reagent-desc-arcryox = Нудотно-синя кріогенна хімічна речовина, здатна лікувати тяжкі рани навіть у мертвих. Однак їй складно стабілізувати пацієнтів.
reagent-name-warfarin = варфарин
reagent-desc-warfarin = Зазвичай використовується як антикоагулянтний препарат. Ускладнює утворення тромбів у крові. При передозуванні може спричинити внутрішню кровотечу.