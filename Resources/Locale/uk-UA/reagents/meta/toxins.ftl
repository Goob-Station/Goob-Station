...
reagent-desc-toxintrash = Смердюча суспензія, ефективно очищена з викинутих матеріалів. Це ідеальне безвідходне перетворення брухту на харчування для воксів, хоча для інших це сильна отрута.
reagent-name-hemorrhinol = геморинол
reagent-desc-hemorrhinol = Токсин, що спричиняє серйозне пошкодження кровоносних судин і швидку кровотечу.