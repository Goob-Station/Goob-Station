...
trait-accentless-desc = У вас немає акценту, який зазвичай має ваш вид
...
trait-hemophilia-desc = Ваше тіло не утворює кровяні згустки.
trait-impaired-mobility-name = Порушена мобільність
trait-impaired-mobility-desc = Вам важко пересуватися без засобу для мобільності.