...
autodoc-add-step-grab-organ = ВЗЯТИ ОРГАН 拿管风琴
# Китайський текст приблизно перекладається як ""Підняти частину тіла"""
autodoc-add-step-grab-part = ВЗЯТИ ЧАСТИНУ ТІЛА 拾起身体部位
...
autodoc-add-step-store-item = ЗБЕРЕГТИ ПРЕДМЕТ 将物品放入存储空间
# Китайський текст приблизно перекладається як ""Встановити Мітку"""
autodoc-add-step-set-label = ВСТАНОВИТИ МІТКУ 设置标签
...
autodoc-add-step-wait = ЧЕКАТИ 等
