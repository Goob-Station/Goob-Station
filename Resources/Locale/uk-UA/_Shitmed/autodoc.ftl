...
autodoc-program-completed = ПРОГРАМА ЗАВЕРШЕНА
autodoc-error = ПОМИЛКА: {$error}
autodoc-fatal-error = КРИТИЧНА ПОМИЛКА: {$error}
autodoc-waiting = ПРОГРАМА ОЧІКУЄ

autodoc-error-missing-patient = ВІДСУТНІЙ ПАЦІЄНТ
autodoc-error-body-part = ЧАСТИНА ТІЛА НЕ ВИЯВЛЕНА
autodoc-error-surgery-impossible = ОБРАНА ОПЕРАЦІЯ НЕМОЖЛИВА
autodoc-error-item-unavailable = ПРЕДМЕТ НЕДОСТУПНИЙ
autodoc-error-surgery-failed = ОПЕРАЦІЯ НЕВДАЛА
autodoc-error-hand-full = МАНІПУЛЯТОР ПОВНИЙ
autodoc-error-storage-full = ЛОТКИ ДЛЯ ПРЕДМЕТІВ ЗАПОВНЕНІ
...
autodoc-view-program-title = ПРОСМОТРІТИ ПРОГРАМУ
...
autodoc-add-step-wait-prompt = Кількість секунд очікування

autodoc-body-part-Other = Інше
autodoc-body-part-Torso = Тулуб
autodoc-body-part-Head = Голова
autodoc-body-part-Arm = Рука
autodoc-body-part-Hand = Долоня
autodoc-body-part-Leg = Нога
autodoc-body-part-Foot = Стопа
autodoc-body-part-Tail = Хвіст

autodoc-body-symmetry-ignored = Будь-яка
autodoc-body-symmetry-None = Відсутня
