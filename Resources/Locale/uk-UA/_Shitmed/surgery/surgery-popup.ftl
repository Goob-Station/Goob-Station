...
surgery-popup-step-SurgeryStepSealDismembermentWound = {$user} зашиває місце відриву кінцівки на {$part} у {$target}.
surgery-popup-step-SurgeryStepCloseBloodOutputs = {$user} зашиває місце кровотечі на {$part} у {$target}.
surgery-popup-step-SurgeryStepRemoveSeveredSkin = {$user} видаляє відмерлу шкіру з {$part} у {$target}.
surgery-popup-step-SurgeryStepRemoveLeftoverBones = {$user} видаляє залишки кісток з {$part} у {$target}.
...
surgery-popup-step-SurgeryStepOpenOrganSlot = {$user} відкриває порожнину в {$part} у {$target}!
surgery-popup-step-SurgeryStepRemoveOrgan-failed = Вам не вдалося видалити орган з якоїсь причини...