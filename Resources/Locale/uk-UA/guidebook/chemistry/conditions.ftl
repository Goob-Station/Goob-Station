...
reagent-effect-condition-guidebook-mob-state-condition = стан моба - { $state }
reagent-effect-condition-guidebook-solution-temperature = температура розчину { $max ->
...
reagent-effect-condition-guidebook-body-temperature = температура тіла { $max ->
            [2147483648] не менше {NATURALFIXED($min, 2)}k
            *[other] { $min ->
                        [0] не більше {NATURALFIXED($max, 2)}k
                        *[other] між {NATURALFIXED($min, 2)}k та {NATURALFIXED($max, 2)}k
...
reagent-effect-condition-guidebook-organ-type = метаболізувальний орган { $shouldhave ->
                                [true] має бути
                                *[false] не має бути
                           } {$name}
...
reagent-effect-condition-guidebook-job-condition = посада цілі - { $job }
