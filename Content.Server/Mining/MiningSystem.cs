...
public sealed class MiningSystem : EntitySystem
{
    ...
    private void OnDestruction(EntityUid uid, OreVeinComponent component, DestructionEventArgs args)
    {
        ...
        var modifier = component.Modifier; // Goidastation
        var toSpawn = (int) _random.NextFloat((float) proto.MinOreYield * modifier, (float) (proto.MaxOreYield+1) * modifier); // Goidastation - Apply fortune
