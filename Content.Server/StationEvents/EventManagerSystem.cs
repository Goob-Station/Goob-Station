...
public sealed class EventManagerSystem : EntitySystem
{
                                      ...
                                      bool allEvents = false) // Goobstation
    {
        ...
        var availableEvents = AvailableEvents(allEvents, allEvents ? int.MaxValue : null, allEvents ? TimeSpan.MaxValue : null); // handles the player counts and individual event restrictions
