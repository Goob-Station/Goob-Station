...
using Content.Server.Station.Components; // Goobstation - Custom Announcers
...
namespace Content.Server.Communications
{
    public sealed class CommunicationsConsoleSystem : EntitySystem
    {
            ...
            CommunicationsConsoleAnnounceMessage message)
        {
            ...
            if (comp.Global)
            {
                _announcer.SendAnnouncement("announce", Filter.Broadcast(), msg, title, comp.Color); // Goobstation - Custom Announcers
            ...
            if (TryComp<StationDataComponent>(_stationSystem.GetOwningStation(uid), out var stationData))
                _announcer.SendAnnouncement("announce", _stationSystem.GetInStation(stationData), msg, title,
                    comp.Color);  // Goobstation - Custom Announcers
