...
using Content.Shared.Mindcontrol;  //Goobstation - MindcontrolImplant
...
public sealed class MindShieldSystem : EntitySystem
{
    ...
    public void MindShieldRemovalCheck(EntityUid implanted, EntityUid implant)
    {
        ...
        if (HasComp<MindcontrolComponent>(implanted))   //Goobstation - MindcoltrolImplant
            RemComp<MindcontrolComponent>(implanted);
    }
}
