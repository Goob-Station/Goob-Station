...
public sealed class HulkSystem : SharedHulkSystem
{
    ...
    private void OnInit(Entity<HulkComponent> ent, ref ComponentInit args)
    {
        ...
        if (TryComp(uid, out HumanoidAppearanceComponent? humanoid))
        {
            ...
            _humanoidAppearance.SetBaseLayerId(uid, HumanoidVisualLayers.HeadSide, comp.BaseLayerExternal, false, humanoid);
            _humanoidAppearance.SetBaseLayerId(uid, HumanoidVisualLayers.HeadTop, comp.BaseLayerExternal, false, humanoid);
            _humanoidAppearance.SetBaseLayerId(uid, HumanoidVisualLayers.Snout, comp.BaseLayerExternal, false, humanoid);
        }
