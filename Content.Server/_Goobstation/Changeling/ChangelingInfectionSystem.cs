...
public sealed partial class ChangelingInfectionSystem : EntitySystem
{
    ...
    {
        if (comp.CurrentState == ChangelingInfectionComponent.InfectionState.WaitingForSoul)
        {
            _antag.ForceMakeAntag<ChangelingRuleComponent>(args.Mind.Comp.Session, "Changeling");
    ...
    public void DoEffects(EntityUid uid, ChangelingInfectionComponent comp)
    {
        ...
        switch (comp.CurrentState)
        {
            ...
            case ChangelingInfectionComponent.InfectionState.FullyInfected:
                ...
                {
                    comp.CurrentState = ChangelingInfectionComponent.InfectionState.WaitingForSoul;
                    return;
                }
