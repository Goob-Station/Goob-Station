...
public sealed class BlobRuleSystem : GameRuleSystem<BlobRuleComponent>
{
    ...
    private static readonly SoundPathSpecifier BlobDetectAudio = new ("/Audio/_ShibaStation/Announcements/blob-zombie-start.ogg");
