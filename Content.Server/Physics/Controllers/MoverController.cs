...
using Content.Goidastation.Common.CCVar; // Goidastation
...
using Robust.Shared.Configuration; // Goidastation
...
{
    [Dependency] private readonly IConfigurationManager _cfg = default!; // Goidastation
    [Dependency] private readonly ThrusterSystem _thruster = default!;
    [Dependency] private readonly SharedTransformSystem _xformSystem = default!;

    private Dictionary<EntityUid, (ShuttleComponent, List<(EntityUid, PilotComponent, InputMoverComponent, TransformComponent)>)> _shuttlePilots = new();

    private float _maxShuttleSpeed; // Goidastation

    public override void Initialize()
    {
        base.Initialize();

        Subs.CVar(_cfg, GoidaCVars.MaxShuttleSpeed, value => _maxShuttleSpeed = value, true); // Goidastation
    ...
    private Vector2 ObtainMaxVel(Vector2 vel, ShuttleComponent shuttle)
    {
        ...
        return _maxShuttleSpeed * vel * MathF.ReciprocalSqrtEstimate(horizComp + vertComp); // Goidastation - now uses cvar
    }
