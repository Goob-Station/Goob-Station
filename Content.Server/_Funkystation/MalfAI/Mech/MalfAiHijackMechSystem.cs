...
namespace Content.Server._Funkystation.MalfAI.Mech;
...
public sealed class MalfAiHijackMechSystem : EntitySystem
{
    ...
    private static readonly TimeSpan HijackDuration = TimeSpan.FromSeconds(120);
    ...
    private void OnHijackMech(Entity<MalfAiMarkerComponent> ent, ref MalfAiHijackMechActionEvent args)
    {
        ...
        hijack.EndTime = _timing.CurTime + HijackDuration;
