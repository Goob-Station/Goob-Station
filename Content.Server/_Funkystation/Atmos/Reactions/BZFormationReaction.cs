...
public sealed partial class BZProductionReaction : IGasReactionEffect
{
    public ReactionResult React(GasMixture mixture, IGasMixtureHolder? holder, AtmosphereSystem atmosphereSystem, float heatScale)
    {
        ...
        var nitrousDecompositionMul = 1f - nitrousOxideDecomposed;

        var bzAdded = bzFormed * nitrousDecompositionMul;
        var n2oRemoved = 0.4f * bzFormed;
        var plasmaRemoved = 0.8f * bzFormed * nitrousDecompositionMul;
