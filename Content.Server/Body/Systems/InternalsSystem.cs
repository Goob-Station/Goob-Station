...
public sealed class InternalsSystem : EntitySystem
{
    ...
    {
        //_alerts.ShowAlert(ent, ent.Comp.InternalsAlert, GetSeverity(ent)); Goidastation - Hide O2 Alert
    }
    ...
    public void DisconnectBreathTool(Entity<InternalsComponent> ent, EntityUid toolEntity)
    {
        ...
        _alerts.ClearAlert(ent, ent.Comp.InternalsAlert); // Goidastation - Hide O2 Alert
    }
