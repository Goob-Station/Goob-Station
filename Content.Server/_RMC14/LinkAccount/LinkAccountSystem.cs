...
public sealed class LinkAccountSystem : EntitySystem
{
    ...
    public override void Initialize()
    {
        ...
        Subs.CVar(_config, GoidaCVars.RMCPatronLobbyMessageTimeSeconds, v => _timeBetweenLobbyMessages = TimeSpan.FromSeconds(v), true);
        Subs.CVar(_config, GoidaCVars.RMCPatronLobbyMessageInitialDelaySeconds, v => _lobbyMessageInitialDelay = TimeSpan.FromSeconds(v), true);
