...
public sealed partial class NoEorgPopup : FancyWindow
{
    ...
    private void InitializeUI()
    {
        ...
        NoEorgMurderboxButton.Text = Loc.GetString("no-erog-popup-murderbox-button");
        NoEorgMurderboxInfo.SetMessage(FormattedMessage.FromMarkupOrThrow(Loc.GetString("no-erog-popup-murderbox-text")));
        NoEorgUndoSkipNotice.SetMessage(FormattedMessage.FromMarkupOrThrow(Loc.GetString("no-erog-popup-undo-skip-notice")));
