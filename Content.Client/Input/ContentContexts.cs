...
namespace Content.Client.Input
{
    ...
    public static class ContentContexts
    {
        public static void SetupContexts(IInputContextContainer contexts)
        {
            ...
            common.AddFunction(ContentKeyFunctions.ResistGrab); // Goidastation - Grab Intent
            ...
            human.AddFunction(ContentKeyFunctions.SmartEquipBack); // Goidastation - Smart equip to back
