...
namespace Content.Client.Lobby.UI
{
    ...
    public sealed partial class HumanoidProfileEditor : BoxContainer
    {
        ...
        public event Action? OnBorgNameButtonPressed;
        private SiliconNameMenu? _siliconNameMenu;
            ...
            MarkingManager markings)
        {
            ...
            OnBorgNameButtonPressed += OpenSiliconNameMenu;
        ...
        private void OpenSiliconNameMenu()
        {
            if (_siliconNameMenu != null)
                _siliconNameMenu.Dispose();

            if (Profile == null)
                return;

            _siliconNameMenu = new SiliconNameMenu();
            _siliconNameMenu.Initialize(this, Profile);
            _siliconNameMenu.OnNameChanged += newName => SetBorgName(newName);
            _siliconNameMenu.OpenCentered();
        }
        ...
        public void RefreshJobs()
        {
            ...
            foreach (var department in departments)
            {
                ...
                if (!_jobCategories.TryGetValue(department.ID, out var category))
                {
                    ...
                    var borgNameButton = new Button()
                    {
                        Name = "BorgName",
                        Text = Loc.GetString("silicon-name-ui-button"),
                        HorizontalAlignment = HAlignment.Right,
                        Visible = department.ID == "Silicon",
                    };
                    ...
                    borgNameButton.OnPressed += _ => OnBorgNameButtonPressed?.Invoke();
        ...
        public void SetBorgName(string newBName)
        {
