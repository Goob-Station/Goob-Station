...
namespace Content.Client.Wires.UI
{
    public sealed class WiresMenu : BaseWindow
    {
        ...
        public WiresMenu()
        {
            ...
            var font = _resourceCache.GetFont("/Fonts/Minecraft/Minecrafter_3.ttf", 13);
            var fontSmall = _resourceCache.GetFont("/Fonts/Minecraft/Minecrafter_3.ttf", 10);
        ...
        private sealed class WireControl : Control
        {
                ...
                IResourceCache resourceCache)
            {
                ...
                var greek = new Label
                {
                    ...
                    FontOverride = _resourceCache.GetFont("/Fonts/Minecraft/Minecraftia.ttf", 12),
                    FontColorOverride = Color.Gray,
                    ToolTip = letter.Name(),
                    MouseFilter = MouseFilterMode.Stop
                };
        ...
        private sealed class StatusLight : Control
        {
            ...
            public StatusLight(StatusLightData data, IResourceCache resourceCache)
            {
                ...
                var font = resourceCache.GetFont("/Fonts/Minecraft/Minecrafter_3.ttf", 12);
