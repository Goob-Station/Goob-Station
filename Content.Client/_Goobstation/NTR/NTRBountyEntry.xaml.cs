...
public sealed partial class NTRBountyEntry : BoxContainer
{
    ...
    public NTRBountyEntry(NTRBountyData bounty, TimeSpan untilNextSkip)
    {
        ...
        if (!_prototype.TryIndex<NTRBountyPrototype>(bounty.Bounty, out var bountyPrototype))
            return;
