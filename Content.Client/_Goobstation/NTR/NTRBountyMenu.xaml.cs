...
public sealed partial class NTRBountyMenu : FancyWindow
{
    public Action<string>? OnLabelButtonPressed;
    public Action<string>? OnSkipButtonPressed;

    public NTRBountyMenu()
    {
    ...
    public void UpdateEntries(List<NTRBountyData> bounties, List<NTRBountyHistoryData> history, TimeSpan untilNextSkip)
    {
