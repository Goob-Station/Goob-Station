...
public sealed partial class AccessibilityTab : Control
{
    public AccessibilityTab()
    {
        ...
        Control.AddOptionCheckBox(GoidaCVars.ChatAutoFillHighlights, AutoFillHighlightsCheckBox); // Goida
        Control.AddOptionColorSlider(GoidaCVars.ChatHighlightsColor, HighlightsColorSlider); // Goida
