...
namespace Content.Client.Options.UI.Tabs
{
    ...
    public sealed partial class KeyRebindTab : Control
    {
        ...
        {
            _cfg.SetCVar(GoidaCVars.AutoGetUp, args.Pressed);
            _cfg.SaveToFile();
        }
        ...
        public KeyRebindTab()
        {
            ...
            AddCheckBox("ui-options-function-auto-get-up", _cfg.GetCVar(GoidaCVars.AutoGetUp), HandleToggleAutoGetUp); // WD EDIT
            InitToggleWalk();
            ...
            AddButton(ContentKeyFunctions.SmartEquipBack); // Goidastation - Equip To Back
