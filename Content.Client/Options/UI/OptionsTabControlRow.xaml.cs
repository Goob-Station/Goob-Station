using System.Linq;
using Content.Client._Shitcode.Options.UI;
...
// Goobstation highlights - start
    ...
    public OptionColorSliderCVar AddOptionColorSlider(
        CVarDef<string> cVar,
        _Shitcode.Options.UI.OptionColorSlider slider)
    {
...
{
    private readonly _Shitcode.Options.UI.OptionColorSlider _slider;
    ...
    public OptionColorSliderCVar(
        ...
        CVarDef<string> cVar,
        _Shitcode.Options.UI.OptionColorSlider slider) : base(controller, cfg, cVar)
    {
        _slider = slider;
