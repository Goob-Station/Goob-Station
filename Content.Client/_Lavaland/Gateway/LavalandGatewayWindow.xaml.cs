...
public sealed partial class LavalandGatewayWindow : FancyWindow
{
    private readonly IGameTiming _timing;

    public event Action<NetEntity>? OpenPortal;
    private List<(NetEntity, string, TimeSpan, bool)> _destinations = [];
    ...
    public void UpdateState(LavalandGatewayBoundUserInterfaceState state)
    {
