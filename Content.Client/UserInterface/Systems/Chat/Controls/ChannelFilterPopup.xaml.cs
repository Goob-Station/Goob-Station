...
using Robust.Shared.Utility; // Goida - start
...
public sealed partial class ChannelFilterPopup : Popup
{
    ...
    private static readonly ChatChannel[] ChannelFilterOrder =
    {
        ...
        ChatChannel.CollectiveMind, // Goidastation - Starlight collective mind port
    ...
    // Goidastation highlights - start
        ...
        string highlights = cfg.GetCVar(GoidaCVars.ChatHighlights);
