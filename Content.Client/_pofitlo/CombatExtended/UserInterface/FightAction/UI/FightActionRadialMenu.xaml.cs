...
public sealed partial class FightActionRadialMenu : RadialMenu
{
    ...
    public void RefreshUI()
    {
        ...
        //main.InitialRadius = 55f; // TODO сделать в зависимости от скейла экрана
        //main.InnerRadiusMultiplier = 0.8f;
        main.OuterRadiusMultiplier = 3f;
        ...
        foreach (var fightAction in fightActionComp.AvailableActions)
        {
            ...
            button.OnPressed += _ => _controller.SetFightAction(fightActionPrototype.СhosenAttackStrategy);
