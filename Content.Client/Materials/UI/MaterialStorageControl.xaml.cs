...
public sealed partial class MaterialStorageControl : ScrollContainer
{
    ...
    [Dependency] private readonly IPrototypeManager _prototypeManager = default!; // Goidastation
    private readonly SiloSystem _silo; // Goidastation
    private readonly TagSystem _tagSystem; // Goidastation
    ...
    public MaterialStorageControl()
    {
        ...
        _tagSystem = _entityManager.System<TagSystem>(); // Goidastation
    }
