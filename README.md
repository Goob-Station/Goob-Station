...
This is a fork from Goob Station called Dream Station. To prevent people forking RobustToolbox, a "content" pack is loaded by the client and server. This content pack contains everything needed to play the game on one specific server this is the content pack for Goob Station.
...
## Contributing
If i am going to make any progress on this project, i would need an immense amount of help as i dont have anything but ideas. anything from anyone is apprecuiated, if anything seems simple enough to teach PLEASE reach out, relevant examples would make learning editory coding easier.
