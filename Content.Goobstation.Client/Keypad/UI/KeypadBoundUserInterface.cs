...
public sealed class KeypadBoundUserInterface : BoundUserInterface
{
    ...
    protected override void Open()
    {
        ...
        _menu.OnDigitPressed += d => SendMessage(new KeypadDigitMessage(d));
        _menu.OnClearPressed += () => SendMessage(new KeypadClearMessage());
        _menu.OnEnterPressed += () => SendMessage(new KeypadEnterMessage());
    }
