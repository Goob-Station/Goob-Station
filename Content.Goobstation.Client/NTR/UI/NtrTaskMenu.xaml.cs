...
public sealed partial class NtrTaskMenu : FancyWindow
{
    ...
    public void UpdateEntries(List<NtrTaskData> tasks, List<NtrTaskHistoryData> history, TimeSpan untilNextSkip)
    {
        ...
        {
            if (string.IsNullOrEmpty(historyEntry.Task) ||
                !prototypeManager.HasIndex<NtrTaskPrototype>(historyEntry.Task))
                continue;

            BountyHistoryContainer.AddChild(new NtrTaskHistoryEntry(historyEntry));
        }
