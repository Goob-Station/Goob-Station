...
public sealed partial class TimeTransferPanel : DefaultWindow
{
    ...
    public Action<(string playerId, List<Shared.Administration.TimeTransferData> transferList, bool overwrite)>? OnTransferMessageSend;
    ...
    public void TimeTransfer(bool overwrite = false)
    {
        ...
        var dataList = new List<Shared.Administration.TimeTransferData>();
        ...
        if (GroupCheckbox.Pressed)
        {
            ...
            {
                var data = new Shared.Administration.TimeTransferData(entry.PlaytimeTracker, GroupTimeLine.Text);
                dataList.Add(data);
            }
        }
        else
        {
            foreach (var entry in JobContainer.Children)
            {
                ...
                var data = new Shared.Administration.TimeTransferData(tracker, timeString);
                dataList.Add(data);
            }
        }
