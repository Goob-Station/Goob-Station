...
public sealed partial class SpellbladeMenu : RadialMenu
{
    ...
    public event Action<ProtoId<Goobstation.Shared.Wizard.Spellblade.SpellbladeEnchantmentPrototype>>? SendSpellbladeSystemMessageAction;
    ...
    public void Refresh()
    {
        ...
        if (!_entManager.TryGetComponent(_item, out Goobstation.Shared.Wizard.Spellblade.SpellbladeComponent? spellblade))
            return;
...
{
    public ProtoId<Goobstation.Shared.Wizard.Spellblade.SpellbladeEnchantmentPrototype> ProtoId { get; set; }
}
