...
namespace Content.Goobstation.Client.Chemistry.UI
{
    ...
    public sealed partial class EnergyReagentDispenserWindow : FancyWindow
    {
        ...
        public void UpdateState(BoundUserInterfaceState state)
        {
            ...
            var batteryPercent = castState.BatteryMaxCharge > 0
                ? (castState.BatteryCharge / castState.BatteryMaxCharge) * 100
                : 0;

            BatteryStatusLabel.Text = $"{castState.BatteryCharge:F0}/{castState.BatteryMaxCharge:F0} ({batteryPercent:F0}%)";
