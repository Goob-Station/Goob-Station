...
public sealed partial class EnergyDomeGeneratorComponent : Component
{
    ...
    [DataField]
    public SoundSpecifier EnergyOutSound = new SoundPathSpecifier("/Audio/_Pirate/Machines/energyshield_down.ogg");

    [DataField]
    public SoundSpecifier TurnOffSound = new SoundPathSpecifier("/Audio/Machines/button.ogg");

    [DataField]
    public SoundSpecifier ParrySound = new SoundPathSpecifier("/Audio/_Pirate/Machines/energyshield_parry.ogg")
    {
