...
public sealed partial class DevilSystem : EntitySystem
{
    ...
    private void OnListen(Entity<DevilComponent> devil, ref ListenEvent args)
    {
        ...
        if (HasComp<BibleUserComponent>(args.Source))
        {
            ...
            //_stun.TryParalyze(devil, devil.Comp.ParalyzeDurationOnTrueName * devil.Comp.BibleUserDamageMultiplier, false); todo marty stun
        ...
        {
            //_stun.TryParalyze(devil, devil.Comp.ParalyzeDurationOnTrueName, false);todo marty stun
