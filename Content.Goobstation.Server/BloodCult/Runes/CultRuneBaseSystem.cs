...
namespace Content.Goobstation.Server.BloodCult.Runes;
...
public sealed partial class CultRuneBaseSystem : EntitySystem
{
    ...
    public override void Initialize()
    {
        ...
        SubscribeLocalEvent<Goobstation.Shared.BloodCult.BloodCultist.BloodCultistComponent, DrawRuneDoAfter>(OnDrawRune);
    ...
    private void OnRuneSelected(Entity<RuneDrawerComponent> ent, ref RuneDrawerSelectedMessage args)
    {
        ...
        if (TryComp(args.Actor, out Goobstation.Server.BloodCult.Empower.BloodCultEmpoweredComponent? empowered))
    ...
    private void OnDrawRune(Entity<Goobstation.Shared.BloodCult.BloodCultist.BloodCultistComponent> ent, ref DrawRuneDoAfter args)
    {
    ...
    private void OnRuneActivate(Entity<CultRuneBaseComponent> rune, ref ActivateInWorldEvent args)
    {
        ...
        if (args.Handled || !HasComp<Goobstation.Shared.BloodCult.BloodCultist.BloodCultistComponent>(args.User) ||
    ...
    {
        if (!HasComp<Goobstation.Shared.BloodCult.BloodCultist.BloodCultistComponent>(args.Examiner) && !HasComp<Goobstation.Shared.BloodCult.Constructs.ConstructComponent>(args.Examiner) &&
    ...
    private void DealDamage(EntityUid user, DamageSpecifier? damage = null)
    {
        ...
        if (TryComp(user, out Goobstation.Server.BloodCult.Empower.BloodCultEmpoweredComponent? empowered))
        {
