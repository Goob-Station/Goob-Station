...
public sealed partial class CultRuneBaseSystem
{
    ...
    public HashSet<EntityUid> GatherCultists(EntityUid rune, float range)
    {
        ...
        entities.RemoveWhere(entity => !HasComp<Goobstation.Shared.BloodCult.BloodCultist.BloodCultistComponent>(entity) && !HasComp<Goobstation.Shared.BloodCult.Constructs.ConstructComponent>(entity));
        return entities;
    }
