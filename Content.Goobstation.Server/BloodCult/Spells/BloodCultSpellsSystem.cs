...
public sealed class BloodCultSpellsSystem : EntitySystem
{
    ...
    public override void Initialize()
    {
        ...
        SubscribeLocalEvent<BloodCultSpellsHolderComponent,
            Goobstation.Shared.BloodCult.Spells.CreateSpeellDoAfterEvent>(OnSpellCreated);

        SubscribeLocalEvent<Goobstation.Shared.BloodCult.Spells.BloodCultEmpEvent>(OnEmp);
        SubscribeLocalEvent<Goobstation.Shared.BloodCult.Spells.SummonEquipmentEvent>(OnSummonEquipment);
    }
    ...
    {
        if (_actions.GetAction(action.Owner, false) is { Comp.UseDelay: not null })
    ...
    private void OnSpellSelected(Entity<BloodCultSpellsHolderComponent> cultist, ref RadialSelectorSelectedMessage args)
    {
        ...
        var createSpellEvent = new Goobstation.Shared.BloodCult.Spells.CreateSpeellDoAfterEvent
        {
    ...
    private void OnSpellCreated(Entity<BloodCultSpellsHolderComponent> cultist,
        ref Goobstation.Shared.BloodCult.Spells.CreateSpeellDoAfterEvent args)
    {
    ...
    private void OnEmp(Goobstation.Shared.BloodCult.Spells.BloodCultEmpEvent ev)
    {
        if (ev.Handled)
            return;
    ...
    private void OnSummonEquipment(Goobstation.Shared.BloodCult.Spells.SummonEquipmentEvent ev)
    {
        if (ev.Handled)
            return;
    ...
    {
        return TryComp(actionUid, out ActionComponent? targetAction) ? targetAction.Icon : null;
    }
