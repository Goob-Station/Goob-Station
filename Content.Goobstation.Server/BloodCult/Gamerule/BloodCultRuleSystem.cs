...
using System.Linq;
using Content.Goobstation.Server.BloodCult.Items.BloodSpear;
...
public sealed class BloodCultRuleSystem : GameRuleSystem<BloodCultRuleComponent>
{
    ...
    private void OnGetBriefing(Entity<BloodCultistRoleComponent> cultist, ref GetBriefingEvent args)
    {
        ...
        var query = EntityQueryEnumerator<RendingRunePlacement.RendingRunePlacementMarkerComponent>();
    ...
    public void RemoveObjectiveAndRole(EntityUid uid)
    {
        ...
        var objectives = mind.Objectives.FindAll(HasComp<Objectives.KillTargetCultComponent>);
    ...
    private void MakeCultist(EntityUid cultist, Entity<BloodCultRuleComponent> rule)
    {
        ...
        EnsureComp<Spells.BloodCultSpellsHolderComponent>(cultist);
    ...
    {
        var allMarkers = EntityQuery<RendingRunePlacement.RendingRunePlacementMarkerComponent>().ToList();
    ...
    private void RemoveAllCultItems(Entity<BloodCultistComponent> cultist)
    {
        ...
        {
            if (container.ContainedEntity != null && HasComp<Goobstation.Shared.BloodCult.Items.CultItemComponent>(container.ContainedEntity.Value))
        ...
        {
            if (TryComp(item, out Goobstation.Shared.BloodCult.Items.CultItemComponent? cultItem) && !cultItem.AllowUseToEveryone &&
    ...
    private void RemoveCultistAppearance(Entity<BloodCultistComponent> cultist)
    {
        ...
        RemComp<Goobstation.Shared.BloodCult.Components.PentagramComponent>(cultist);
    }
    ...
    private void UpdateCultistsAppearance(BloodCultRuleComponent cultRule, CultStage prevStage)
    {
        switch (cultRule.Stage)
        {
            ...
            case CultStage.Pentagram:
                foreach (var cultist in cultRule.Cultists)
                {
                    EnsureComp<Goobstation.Shared.BloodCult.Components.PentagramComponent>(cultist);
                }
