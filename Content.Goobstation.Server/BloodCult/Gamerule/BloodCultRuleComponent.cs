...
namespace Content.Goobstation.Server.BloodCult.Gamerule;
...
public sealed partial class BloodCultRuleComponent : Component
{
    ...
    public List<Entity<Goobstation.Shared.BloodCult.BloodCultist.BloodCultistComponent>> Cultists = new();

    public List<Entity<Goobstation.Shared.BloodCult.Constructs.ConstructComponent>> Constructs = new();
}
