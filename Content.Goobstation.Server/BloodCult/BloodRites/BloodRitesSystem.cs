...
namespace Content.Goobstation.Server.BloodCult.BloodRites;
...
public sealed class BloodRitesSystem : EntitySystem
{
    ...
    public override void Initialize()
    {
        ...
        SubscribeLocalEvent<BloodRitesAuraComponent, Goobstation.Shared.BloodCult.Spells.BloodRitesExtractDoAfterEvent>(OnDoAfter);
    ...
    private void OnAfterInteract(Entity<BloodRitesAuraComponent> rites, ref AfterInteractEvent args)
    {
        if (!args.Target.HasValue || args.Handled || args.Target == args.User ||
            HasComp<Goobstation.Shared.BloodCult.BloodCultist.BloodCultistComponent>(args.Target))
            return;
        ...
        if (HasComp<BloodstreamComponent>(args.Target))
        {
            ...
            var ev = new Goobstation.Shared.BloodCult.Spells.BloodRitesExtractDoAfterEvent();
    ...
    private void OnDoAfter(Entity<BloodRitesAuraComponent> rites, ref Goobstation.Shared.BloodCult.Spells.BloodRitesExtractDoAfterEvent args)
    {
    ...
    private void OnCultistHit(Entity<BloodRitesAuraComponent> rites, ref MeleeHitEvent args)
    {
        ...
        {
            if (!HasComp<Goobstation.Shared.BloodCult.BloodCultist.BloodCultistComponent>(target) && !HasComp<Goobstation.Shared.BloodCult.Constructs.ConstructComponent>(target))
                return;
