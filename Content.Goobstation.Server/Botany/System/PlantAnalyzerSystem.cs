...
using Content.Goobstation.Shared.AbstractAnalyzer;
using Content.Goobstation.Shared.Botany.Components;
using Content.Goobstation.Shared.Botany.PlantAnalyzer;
...
namespace Content.Goobstation.Server.Botany.System;
