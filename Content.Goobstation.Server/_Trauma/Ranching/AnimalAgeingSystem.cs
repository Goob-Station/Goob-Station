...
public sealed partial class AnimalAgeingSystem : EntitySystem
{
    ...
    public override void Initialize()
    {
        ...
        SubscribeLocalEvent<AnimalPolymorphRequestEvent>(OnPolymorphRequest);
    }

    private void OnPolymorphRequest(ref AnimalPolymorphRequestEvent ev)
    {
        _polymorph.PolymorphEntity(ev.Target, ev.Configuration);
    }
